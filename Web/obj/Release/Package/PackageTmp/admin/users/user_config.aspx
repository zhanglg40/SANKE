<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_config.aspx.cs" Inherits="Web.admin.users.user_config" ValidateRequest="false" %>
  ...
  <dl>
    ...
    <dd>
      <div class="rule-multi-radio">
        ...
        <asp:ListItem Value="4" Text="<%$ Resources:lang,Invitation%>"></asp:ListItem>
        </asp:RadioButtonList>
      </div>
    </dd>
  </dl>
