<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_express.aspx.cs" Inherits="Web.admin.dialog.dialog_express" %>
...
<script type="text/javascript">
    ...
    function submitForm() {
        //验证表单
        if ($("#ddlExpressId").val() == "") {
            W.$.dialog.alert('请选择配送小区！', function () { $("#ddlExpressId").focus(); }, api);
            return false;
        }
        //组合参数
        var postData = {
