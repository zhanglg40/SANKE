...
<div class="tab-content">
  ...
  <dl>
    ...
    <dd>
      <div class="rule-multi-checkbox">
        ...
        <asp:ListItem Value="1" Selected>允许评论</asp:ListItem>
  ...
  <dl>
    ...
    <dl ID="div_english_name" runat="server" visible="false">
    <dt><asp:Label ID="div_english_name_title" runat="server" Text="波兰名" /></dt>
    <dd>
       <asp:TextBox ID="field_control_english_name" runat="server" CssClass="input normal" datatype="*0-100" sucmsg=" " />
  ...
  <dl ID="div_goods_no" runat="server" visible="false">
    <dt><asp:Label ID="div_goods_no_title" runat="server" Text="编号" /></dt>
    <dd>
      <asp:TextBox ID="field_control_goods_no" runat="server" CssClass="input normal" datatype="n0-10" sucmsg=" " />
      <asp:Label ID="div_goods_no_tip" runat="server" />
    </dd>
  </dl>
      <dl ID="div_Barcode" runat="server" visible="false">
    <dt><asp:Label ID="div_Barcode_title" runat="server" Text="条形码" /></dt>
    <dd>
      <asp:TextBox ID="field_control_Barcode" runat="server" CssClass="input normal" datatype="*0-100" sucmsg=" " />
      <asp:Label ID="div_Barcode_tip" runat="server" />
    </dd>
  </dl>
    <dl ID="div_sppp" runat="server" visible="false">
    <dt><asp:Label ID="div_sppp_title" runat="server" Text="商品品牌" /></dt>
    <dd> 
     <div class="rule-single-select">
    <asp:DropDownList id="ddlvote_id" runat="server" datatype="*" sucmsg=" "></asp:DropDownList>
    </div>
    </dd>
  </dl>
  <dl ID="div_stock_quantity" runat="server" visible="false">
    ...
    <dd>
      <asp:TextBox ID="field_control_stock_quantity" runat="server" CssClass="input small" datatype="n" sucmsg=" " ></asp:TextBox>
      <asp:Label ID="div_stock_quantity_tip" runat="server" CssClass="Validform_checktip" />
    </dd>
  </dl>
      <dl ID="div_threshold" runat="server" visible="false">
    <dt><asp:Label ID="div_threshold_title" runat="server" Text="库存阀值" /></dt>
    <dd>
      <asp:TextBox ID="field_control_threshold" runat="server" CssClass="input small" datatype="n" sucmsg=" " ></asp:TextBox>
      <asp:Label ID="div_threshold_tip" runat="server" CssClass="Validform_checktip" />
    </dd>
  </dl>
  <dl ID="div_market_price" runat="server" visible="false">
    <dt><asp:Label ID="div_market_price_title" runat="server" Text="市场价格" /></dt>
    <dd>
      <asp:TextBox ID="field_control_market_price" runat="server" CssClass="input small" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" ">0</asp:TextBox> PLN
  ...
  <dl ID="div_sell_price" runat="server" visible="false">
    ...
    <dd>
      <asp:TextBox ID="field_control_sell_price" readonly="true" runat="server" CssClass="input small" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" ">0</asp:TextBox> PLN
      <asp:Label ID="div_sell_price_tip" runat="server" CssClass="Validform_checktip" />
    </dd>
  </dl>
      <dl ID="div_price" runat="server"  visible="false">
           <dt><asp:Label ID="Label1" runat="server" Text="价格" /></dt>
           <dd>
    <table border="0" cellspacing="0" cellpadding="0" class="border-table">
        <tr>
            <td>进货价</td> 
            <td><asp:TextBox ID="field_control_PurchasePrice" runat="server" CssClass="input small" datatype="n" sucmsg=" " >0</asp:TextBox>PLN</td>
            <td>批发价</td>
            <td><asp:TextBox ID="field_control_WholesalePrice" runat="server" CssClass="input small" datatype="n" sucmsg=" " >0</asp:TextBox>PLN</td>
            <td>特别价</td>
            <td><asp:TextBox ID="field_control_SpecialPrice" runat="server" CssClass="input small" datatype="n" sucmsg=" " >0</asp:TextBox>PLN</td>
        </tr>
        <tr>
            <td>零售价</td>
            <td><asp:TextBox ID="field_control_RetailPrice" runat="server" CssClass="input small" datatype="n" sucmsg=" " >0</asp:TextBox>PLN</td>
            <td>税率</td>
            <td><asp:TextBox ID="field_control_TaxRate" runat="server" CssClass="input small" datatype="n" sucmsg=" " >0</asp:TextBox>%</td>
            <td>折扣率</td>
            <td><asp:TextBox ID="field_control_DiscountRate" runat="server" CssClass="input small" datatype="n" sucmsg=" " >0</asp:TextBox>%</td>
        </tr>
    </table></dd>
          </dl>
        <dl ID="div_PriceMode" runat="server"  visible="false">
    <dt><asp:Label ID="div_PriceMode_title" runat="server" Text="价格模式" /></dt>
    <dd> 
     <div class="rule-single-select">
    <asp:DropDownList id="field_control_PriceMode" runat="server" datatype="*" sucmsg=" "></asp:DropDownList>
    </div>
    </dd>
  </dl>
        ...
        <ul>
          <asp:Repeater ID="rptAlbumList" runat="server">
            ...
            <li>
              ...
              <a href="javascript:;" onclick="delImg(this);"><asp:Literal runat="server" Text="<%$ Resources:lang,delete%>" /></a>
            </li>
            </ItemTemplate>
          </asp:Repeater>
        </ul>
