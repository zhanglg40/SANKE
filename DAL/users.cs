...
namespace DAL
{
    ...
    public partial class users
    {
        ...
        /// <summary>
        /// 检查" + Resources.lang.username+ "是否存在
        /// </summary>
        ...
        /// <summary>
        /// 根据" + Resources.lang.username+ "取得Salt
        /// </summary>
        public string GetSalt(string user_name)
        {
            //尝试" + Resources.lang.username+ "取得Salt
            StringBuilder strSql = new StringBuilder();
        ...
        /// <summary>
        /// 根据" + Resources.lang.username+ "密码返回一个实体
        /// </summary>
        ...
        /// <summary>
        /// 根据" + Resources.lang.username+ "返回一个实体
        /// </summary>
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,group_id,express_id,user_name,password,salt,email,nick_name,avatar,sex,birthday,telphone,mobile,qq,address,safe_question,safe_answer,amount,point,exp,status,reg_time,reg_ip ");
