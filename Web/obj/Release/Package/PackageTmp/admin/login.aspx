        ...
        <div class="control-group">
         ...
         <div class="control-group">
          <div class="rule-single-select">
           <label style="font-size:17px;font-family:Microsoft YaHei;">选 择 语 言：</label>
          <asp:DropDownList ID="txtLanguage" runat="server" AutoPostBack="True" style="width:180px;background-color:rgb(250, 255, 189);font-size:17px;padding-left:50px;margin-left:15px" onselectedindexchanged="ddlProperty_SelectedIndexChanged">
            <asp:ListItem Value="zh-CN" Selected="True">中文</asp:ListItem>
            <asp:ListItem Value="pl-PL">波兰文</asp:ListItem>
          </asp:DropDownList>
        </div>
         </div>
