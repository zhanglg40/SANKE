...
namespace Web.UI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        /// 返回用户头像图片地址
        /// </summary>
        /// <param name="user_name">" + Resources.lang.username+ "</param>
        ...
        protected DataTable get_user_address(int page_size, int page_index, string strwhere, out int totalcount)
        {
            return new BLL.user_address().GetList(page_size, page_index, strwhere, "id desc", out totalcount).Tables[0];
        }
        /// <summary>
        /// 用户邀请码列表
        /// </summary>
        ...
        {
            string _where = "type='" + AXEnums.CodeEnum.Register.ToString() + "'";
            if (!string.IsNullOrEmpty(strwhere))
            {
                _where += " and " + strwhere;
            }
        ...
        /// <param name="strwhere">查询条件</param>
        /// <returns></returns>
        protected DataTable get_user_express_list(string strwhere)
        {
            string _where = "is_lock=0 ";
            if (!string.IsNullOrEmpty(strwhere))
            {
            ...
            return new BLL.express().GetList(100, _where, "sort_id asc,id desc").Tables[0];
        }

        /// <summary>
        /// 返回邀请码状态
        /// </summary>
        /// <param name="str_code">" + Resources.lang.Invitation+ "</param>
