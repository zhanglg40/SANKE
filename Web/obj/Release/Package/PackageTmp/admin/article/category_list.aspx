  ...
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        ...
        <li><asp:LinkButton ID="btnDelete" runat="server" CssClass="del" OnClientClick="return ExePostBack('btnDelete','本操作会删除本类别及下属子类别，是否继续？');" onclick="btnDelete_Click"><i></i><span><asp:Literal runat="server" Text="<%$ Resources:lang,delete%>" /></span></asp:LinkButton></li>
      </ul>
    </div>
  </div>
</div>
...
<ItemTemplate>
  <tr>
    ...
    <td class="oldid"><%#Eval("id")%></td>
       <td style="display:none" class="newid"><%#Eval("class_no")%></td>
    <td >
