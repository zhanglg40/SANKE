...
namespace Model
{
    ...
    public class siteconfig
    {
        ...
        private string _webpath = "aspx/main/";
        ...
        private string _sysdatabaseprefix = "ax_";
        private string _sysencryptstring = "AoXiang";

        private string _neworderemail = "";
        private int _neworderstatus = 0;
        private int _mailtype = 1;
        #region 网站基本信息==================================
        /// <summary>
        /// 网站名称
        /// </summary>
        ...
        {
            get { return _neworderemail; }
            set { _neworderemail = value; }
        }
        public int neworderstatus
        {
            get { return _neworderstatus; }
            set { _neworderstatus = value; }
        }
        public int mailtype
        {
