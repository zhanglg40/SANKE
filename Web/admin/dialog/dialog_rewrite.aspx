<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_rewrite.aspx.cs" Inherits="Web.admin.dialog.dialog_rewrite" %>
...
<script type="text/javascript">
    ...
    function createVarHtml() {
        ...
        + '<td><a title="删除" class="img-btn del operator" onclick="delVarTr(this);"><asp:Literal runat="server" Text="<%$ Resources:lang,delete%>" /></a></td>'
        + '</tr>'
        return varHtml;
    }
