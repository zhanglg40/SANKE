<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nav_list.aspx.cs" Inherits="Web.admin.settings.nav_list" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="nav_edit.aspx?action=<%=AXEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
        ...
        <li><asp:LinkButton ID="btnDelete" runat="server" CssClass="del" OnClientClick="return ExePostBack('btnDelete','本操作会删除本导航及下属子导航，是否继续？');" onclick="btnDelete_Click"><i></i><span><asp:Literal runat="server" Text="<%$ Resources:lang,delete%>" /></span></asp:LinkButton></li>
      </ul>
    </div>
  </div>
</div>
...
<ItemTemplate>
  <tr>
    ...
    <td style="white-space:nowrap;word-break:break-all;overflow:hidden;">
      ...
      <a href="nav_edit.aspx?action=<%#AXEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a>
    ...
    <td align="center" style="white-space:nowrap;word-break:break-all;overflow:hidden;">
      <a href="nav_edit.aspx?action=<%#AXEnums.ActionEnum.Add %>&id=<%#Eval("id")%>">添加子级</a>
      <a href="nav_edit.aspx?action=<%#AXEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
    </td>
  </tr>
</ItemTemplate>
<FooterTemplate>
