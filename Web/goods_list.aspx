...
override protected void OnInit(EventArgs e)
{
   ...
   */
	...
	templateBuilder.Append("&vote_id=" + Utils.ObjectToStr(cdrhot["id"]) + "\" class=\"xuan\" >" + Utils.ObjectToStr(cdrhot["seo_title"]) + "</a>\r\n            ");
	}
	else
	{
	...
	templateBuilder.Append("\r\n            <a href=\"?category_id=");
	templateBuilder.Append(Utils.ObjectToStr(category_id));
	templateBuilder.Append("&vote_id=" + Utils.ObjectToStr(cdrhot["id"]) + "\" >" + Utils.ObjectToStr(cdrhot["seo_title"]) + "</a>\r\n            ");
	}	//end for if
	...
	templateBuilder.Append("\">");
         if (lang.Equals("pl-PL")){
             templateBuilder.Append(Utils.ObjectToStr(cdr23["seo_title"]));
         }else{
              templateBuilder.Append(Utils.ObjectToStr(cdr23["title"]));
         }
