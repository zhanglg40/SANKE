...
{
    public partial class dialog_list : Web.UI.ManagePage
    {
        private int id = 0;
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("dialog_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
        ...
        protected void lbtnViewTxt_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("dialog_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
