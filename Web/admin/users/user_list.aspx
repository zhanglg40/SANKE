<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_list.aspx.cs" Inherits="Web.admin.users.user_list" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="user_edit.aspx?action=<%=AXEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    ...
    <th align="left" width="12%">配送小区</th>
...
<ItemTemplate>
  <tr>
    ...
    <td width="64">
      <a href="user_edit.aspx?action=<%#AXEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
    ...
    <td><%#new BLL.user_groups().GetTitle(Convert.ToInt32(Eval("group_id")))%></td>
    ...
    <td align="center"><a href="user_edit.aspx?action=<%#AXEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
