<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comment_edit.aspx.cs" Inherits="Web.admin.article.comment_edit" ValidateRequest="false" %>
...
<div class="tab-content">
  <dl>
    <dt>文章标题</dt>
    <dd><%=new BLL.article().GetTitle(model.article_id)%></dd>
  </dl>
  <dl>
    <dt>评论用户</dt>
