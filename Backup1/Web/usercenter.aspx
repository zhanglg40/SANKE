...
override protected void OnInit(EventArgs e)
{
	...
	*/
    ...
    ////templateBuilder.Append("\r\n					</ul>\r\n					</div>\r\n					");
    templateBuilder.Append("<div class=\"header_subclass\">\r\n       ");
    ...
    templateBuilder.Append(linkurl("usercenter", "address"));
    	templateBuilder.Append("\">收货地址</a></li>\r\n        <li><a href=\"");
   	templateBuilder.Append("/shoplist.aspx\">店铺管理</a></li> <li><a href=\"");
...
//	templateBuilder.Append(Utils.ObjectToStr(expressModel.title));
	//templateBuilder.Append("</dd>\r\n        </dl>\r\n        \r\n    ");
    templateBuilder.Append("    <dl>\r\n          <dt>本次登录IP：</dt>\r\n          <dd>");
    ...
    //if (Utils.ObjectToStr(drxq["title"])==expressModel.title)
    //{

    //templateBuilder.Append("\r\n        	<option  selected=\"selected\" value=\"" + Utils.ObjectToStr(drxq["id"]) + "\"> " + Utils.ObjectToStr(drxq["title"]) + "</option>\r\n         ");
    //}
    //else
    //{
    ...
    else if (action == "address")
    {
        ...
        templateBuilder.Append("<tr><th>收货人</th><th>城市</th><th>收货地址</th><th>邮编</th><th>联系电话</th><th>手机号</th><th>编辑</th><th>删除</th><th>默认</th></tr> ");
     //   templateBuilder.Append("<tr><td>1</td><td>1</td><td>1</td><td>1</td><td>1</td><td>1</td><td>1</td></tr> </table>");
        ...
        foreach (DataRow dr in list1.Rows)
        {
            ...
            templateBuilder.Append("\r\n        </td>\r\n        <td width=\"30\"><a  href=\"/address.aspx?action=Edit&id=" + Utils.ObjectToStr(dr["id"]) + "\">编辑</a></td>\r\n    ");
            templateBuilder.Append("<td width=\"30\"><a onclick=\"ExecDelete('/tools/submit_ajax.ashx?action=user_address_delete'," + Utils.ObjectToStr(dr["id"]) + ", 'turl');\" href=\"javascript:;\">删除</a></td>\r\n    ");
