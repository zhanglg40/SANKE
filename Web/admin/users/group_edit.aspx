<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="group_edit.aspx.cs" Inherits="Web.admin.users.group_edit" %>
...
<body class="mainbody">
    ...
    <div class="location">
        <a href="group_list.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../center.aspx"
            class="home"><i></i><asp:Literal runat="server" Text="<%$ Resources:lang,home%>" /></a> <i class="arrow"></i><a href="group_list.aspx">
