c<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.UI.Page.userorder_show" ValidateRequest="false" %>
   ...
   */
    ...
    if (model.payment_status > 0)
    {
        ...
        if (model.payment_status == 2)
        {
            if (lang.Equals("pl-PL"))
            {
                templateBuilder.Append("\r\n            <div class=\"order_flow_arrive\">\r\n              <a class=\"order_flow_input\">Płacić</a>\r\n              <span><p class=\"name\">Zapłacono</p><p>");
            }
            else
            {
        ...
        else
        {
            if (lang.Equals("pl-PL"))
            {
                templateBuilder.Append("\r\n            <div class=\"order_flow_wait\">\r\n              <a class=\"order_flow_input\">Płacić</a>\r\n              <span><p class=\"name\">Do zapłaty</p></span>\r\n            </div>\r\n            ");
            }
            else
            {
    ...
    else
    {
        ...
        if (model.status < 2)
        {
            if (lang.Equals("pl-PL"))
            {
                templateBuilder.Append("\r\n            <div class=\"order_flow_wait\">\r\n              <a class=\"order_flow_input\">Potwierdzenie</a>\r\n              <span><p class=\"name\">Potwierdzić</p></span>\r\n            </div>\r\n            ");
            }
            else
            {
        ...
        else
        {
            if (lang.Equals("pl-PL"))
            {
                templateBuilder.Append("\r\n            <div class=\"order_flow_arrive\">\r\n              <a class=\"order_flow_input\">Potwierdzenie</a>\r\n              <span><p class=\"name\">Zostało potwierdzone</p><p>");
            }
            else
            {
    ...
    if (model.express_status == 1)
    {
        if (lang.Equals("pl-PL"))
        {
            templateBuilder.Append("\r\n          <div class=\"order_flow_wait\">\r\n            <a class=\"order_flow_input\">Dostawa</a>\r\n            <span><p class=\"name\">Dostarczyć</p></span>\r\n          </div>\r\n          ");
        }
        else
        {
    ...
    else if (model.express_status == 2)
    {
        ...
        {
            templateBuilder.Append("\r\n          <div class=\"order_flow_arrive\">\r\n            <a class=\"order_flow_input\">Dostawa</a>\r\n            <span><p class=\"name\">Został dostarczony</p><p>");
        }
    ...
    if (model.status > 2)
    {
        if (lang.Equals("pl-PL"))
        {
            templateBuilder.Append("\r\n          <div class=\"order_flow_right_arrive\">\r\n            <a class=\"order_flow_input\">Kompletny</a>\r\n            <span><p class=\"name\">Ukończono</p><p>");
        }
        else
        {
    ...
    else
    {
        if (lang.Equals("pl-PL"))
        {
            templateBuilder.Append("\r\n          <div class=\"order_flow_right_wait\">\r\n            <a class=\"order_flow_input\">Kompletny</a>\r\n            <span><p class=\"name\">Nie ukończono</p></span>\r\n          </div>\r\n          ");
        }
        else
        {
    ...
    else if (model.status == 4)
    {
        if (lang.Equals("pl-PL"))
        {
            templateBuilder.Append("\r\n        <div style=\"text-align:center;line-height:50px; font-size:20px; color:Red;\">Zlecenie zostało anulowane</div>\r\n        ");
        }
        else
        {
    ...
    else if (model.status == 5)
    {
        if (lang.Equals("pl-PL"))
        {
            templateBuilder.Append("\r\n        <div style=\"text-align:center;line-height:50px; font-size:20px; color:Red;\">Zamówienie zostało unieważnione</div>\r\n        ");
        }
        else
        {
	...
	templateBuilder.Append("\r\n        <tr><td colspan=\"8\" align=\"center\">" + Resources.lang.NoRecords+ "</td></tr>\r\n        ");
	}	//end for if
     if (lang.Equals("pl-PL"))
     {
         templateBuilder.Append("\r\n      </table>\r\n      <div class=\"line10\"></div>\r\n      <div style=\"text-align:right;\">\r\n        Ilość towaru：<span class=\"red\">PLN");
         templateBuilder.Append(Utils.ObjectToStr(model.real_amount));
         templateBuilder.Append("</span>&nbsp; &nbsp;+ &nbsp; Ładunek：<span class=\"red\">PLN");
         templateBuilder.Append(Utils.ObjectToStr(model.express_fee));
         templateBuilder.Append("</span>&nbsp; &nbsp;+ &nbsp; Opłata：<span class=\"red\">PLN");
         templateBuilder.Append(Utils.ObjectToStr(model.payment_fee));
         templateBuilder.Append("</span><br />\r\n        <b>Łączna kwota należna：<span class=\"red\">PLN");
     }
     else
     {
         templateBuilder.Append("\r\n      </table>\r\n      <div class=\"line10\"></div>\r\n      <div style=\"text-align:right;\">\r\n        商品金额：<span class=\"red\">￥");
