...
using API.Payment.Tenpay;
using Common;

namespace Web.api.payment.tenpay
{
    public partial class index : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            decimal order_amount = AXRequest.GetFormDecimal("pay_order_amount", 0); //" + Resources.lang.amount+ "
            string user_name = AXRequest.GetFormString("pay_user_name"); //支付" + Resources.lang.username+ "
