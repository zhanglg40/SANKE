...
override protected void OnInit(EventArgs e)
{
   ...
   */
	...
	string pagelist = get_page_link(15, page, totalcount, linkurl("search","?channel_name="+channel_name+"&keyword=" + Server.UrlEncode(keyword) + "&page=__id__"));
         ...
         if (lang.Equals("pl-PL")) {
             templateBuilder.Append(" <!--取得分页页码列表-->\r\n    <h1 class=\"main_tit\">\r\n      Szukanie<strong>Search</strong>\r\n      <i>Szukaj słów kluczowych： <b class=\"blue\">");
	templateBuilder.Append(Utils.ObjectToStr(keyword));
    templateBuilder.Append("</b> ，Jest <b class=\"red\">");
	templateBuilder.Append(Utils.ObjectToStr(totalcount));
    templateBuilder.Append("</b> rekordów</i>\r\n    </h1>\r\n    <div class=\"line20\"></div>\r\n    <ul class=\"search_list\">\r\n      ");
         }else{
	...
	if (dr["name"].ToString()=="goods")
	{
        ...
        templateBuilder.Append("<p><strong>" + Resources.lang.membercentre + " <em id=\"Em21\">" + Utils.ObjectToStr(dr["Barcode"]) + "</em> </strong>\r\n</p>		<p>\r\n						<strong>" + Resources.lang.price + "： <em id=\"Em21\">" + Utils.ObjectToStr(dr["sell_price"]) + "</em> PLN</strong>\r\n					</p>\r\n	");
