<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="url_rewrite_list.aspx.cs" Inherits="Web.admin.settings.url_rewrite_list" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="url_rewrite_edit.aspx?action=<%=AXEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
        <li><a class="all" href="javascript:;" onclick="checkAll(this);"><i></i><span>全选</span></a></li>
        <li><asp:LinkButton ID="btnDelete" runat="server" CssClass="del" OnClientClick="return ExePostBack('btnDelete','本操作会导致网站前台无法运作，是否继续？');" onclick="btnDelete_Click"><i></i><span><asp:Literal runat="server" Text="<%$ Resources:lang,delete%>" /></span></asp:LinkButton></li>
      </ul>
      <div class="menu-list">
        ...
        <div class="rule-single-select">
          <asp:DropDownList ID="ddlPageType" runat="server" AutoPostBack="True" onselectedindexchanged="ddlPageType_SelectedIndexChanged">
              ...
              <asp:ListItem Value="index">"+Resources.lang.home+"</asp:ListItem>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center"><a href="url_rewrite_edit.aspx?action=<%#AXEnums.ActionEnum.Edit %>&name=<%#Eval("name")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
