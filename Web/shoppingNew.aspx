<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.UI.Page.shoppingNew" ValidateRequest="false" %>
...
templateBuilder.Append(" function get_logon_now() {\r\n        return logon_now;\r\n    }\r\n    function get_real_now() {\r\n        var diff = browser_now.getTime() - logon_now.getTime();\r\n        var now = new Date();\r\n        return new Date(now.getTime() - diff);\r\n    }\r\n</");
   ...
   */
   ...
   templateBuilder.Append("<th width=\"80\" align=\"center\">商店名称</th>\r\n        ");
   ...
   //  templateBuilder.Append("<th width=\"100\" align=\"center\">积分小计</th>\r\n        ");
	...
	DataSet ls1 = get_cart_listNew();

    foreach (DataRow row in ls1.Tables[0].Rows)
	{

	templateBuilder.Append("\r\n      <tr>\r\n        <td><a target=\"_blank\" href=\"");
    templateBuilder.Append(linkurl("goods_show", row["goods_id"]));

	templateBuilder.Append("\"><img src=\"");
	templateBuilder.Append(row["img_url"]);
	templateBuilder.Append("\" class=\"img\" /></a></td>\r\n        <td><a target=\"_blank\" href=\"");
    templateBuilder.Append(linkurl("goods_show", row["goods_id"].ToString()));

	templateBuilder.Append("\">");
    templateBuilder.Append(Utils.ObjectToStr(row["title"]));
    templateBuilder.Append("</a></td>\r\n        ");
    templateBuilder.Append("<td align=\"center\">");
    templateBuilder.Append(Utils.ObjectToStr(row["companyname"]));
    templateBuilder.Append("</td>\r\n        "); 
    templateBuilder.Append("<td align=\"center\">");
    templateBuilder.Append(Utils.ObjectToStr(row["sell_price"]));
    templateBuilder.Append("<input name=\"goods_price\" type=\"hidden\" value=\"");
    templateBuilder.Append(Utils.ObjectToStr(row["sell_price"]));
    templateBuilder.Append("\" /> PLN</td>\r\n ");
    templateBuilder.Append("       <td align=\"center\">\r\n          <a href=\"javascript:;\" class=\"reduce\" title=\"减一\" onclick=\"CartComputNumNew(this, '");
    templateBuilder.Append(Utils.ObjectToStr(config.webpath));
    templateBuilder.Append("', '");
    templateBuilder.Append(Utils.ObjectToStr(row["id"].ToString()));
     templateBuilder.Append("', '");
     templateBuilder.Append(Utils.ObjectToStr(row["companyid"].ToString()));
    ...
    templateBuilder.Append(Utils.ObjectToStr(row["quantity"]));
    templateBuilder.Append("\" onblur=\"CartAmountTotal(this, '");
    templateBuilder.Append(Utils.ObjectToStr(config.webpath));
    templateBuilder.Append("', '");
    templateBuilder.Append(Utils.ObjectToStr(row["id"]));
    templateBuilder.Append("');\" onkeypress=\"return (/[\\d]/.test(String.fromCharCode(event.keyCode)))\" />\r\n          <a href=\"javascript:;\" class=\"subjoin\" title=\"加一\" onclick=\"CartComputNumNew(this,'");
    templateBuilder.Append(Utils.ObjectToStr(config.webpath));
    templateBuilder.Append("', '");
    templateBuilder.Append(Utils.ObjectToStr(row["id"]));
    templateBuilder.Append("', '");
    ...
    templateBuilder.Append((Convert.ToDecimal(row["sell_price"]) * Convert.ToDecimal(row["quantity"])).ToString());
    ...
    templateBuilder.Append("<td align=\"center\"><a onclick=\"DeleteCartNew(this,'");
    templateBuilder.Append(Utils.ObjectToStr(config.webpath));
    templateBuilder.Append("','");
    templateBuilder.Append(Utils.ObjectToStr(row["id"]));
    ...
    templateBuilder.Append("<div class=\"line20\"></div>\r\n    <div class=\"right\">\r\n      <a class=\"btn\" href=\"");
	templateBuilder.Append(linkurl("index"));

	templateBuilder.Append("\">继续购物</a>\r\n      ");
    if (ls1.Tables[0].Rows.Count == 0)
	{
	...
	templateBuilder.Append(linkurl("shoppingNew","confirm"));

	templateBuilder.Append("\">提交订单</a>\r\n      ");
	}	//end for if
    ...
    if (lang.Equals("pl-PL"))
    {
        templateBuilder.Append("\">" + Resources.lang.returns + "</a></span>\r\n      Potwierdź zamówienie<strong>Confirm order</strong>\r\n    </h1>\r\n    <div class=\"cart_step\">\r\n      <ul>\r\n        <li class=\"item\"><span>1</span>Do koszyka</li>\r\n        <li class=\"selected\"><span>2</span>Wypełnij informacje o zamówieniu</li>\r\n        <li class=\"last\"><span>3</span>Płatność / zamówienie</li>\r\n      </ul>\r\n    </div>\r\n    <div class=\"line20\"></div>\r\n    \r\n    <form name=\"order_form\" id=\"order_form\" url=\"");
    }
    else
    {
    ...
    templateBuilder.Append(Utils.ObjectToStr(config.webpath));
    templateBuilder.Append("tools/submit_ajax.ashx?action=order_saveNew\">\r\n       <h3 class=\"bar_tit\">1、" + Resources.lang.paymentMethod + "</h3>\r\n    <ul class=\"item_box\">\r\n      ");
    ...
    templateBuilder.Append("\r\n    </ul>\r\n    \r\n    <div class=\"line20\"></div>\r\n    <h3 class=\"bar_tit\">2、" + Resources.lang.goodlist + "</h3>\r\n    <table width=\"938\" border=\"0\" align=\"center\" cellpadding=\"8\" cellspacing=\"0\" class=\"cart_table\">\r\n      <tr>\r\n        <th width=\"64\"></th>\r\n        <th align=\"left\">" + Resources.lang.productName + "</th>\r\n       ");
    templateBuilder.Append(" <th width=\"80\" align=\"center\">" + Resources.lang.store + "</th>\r\n        ");
  templateBuilder.Append("<th width=\"80\" align=\"center\">" + Resources.lang.unitPrice + "</th>\r\n        <th width=\"80\" align=\"center\">" + Resources.lang.buycount + "</th>\r\n              <th width=\"100\" align=\"center\">" + Resources.lang.subtotal + "</th>\r\n       "); 
      //  templateBuilder.Append(" <th width=\"100\" align=\"center\">积分小计</th>\r\n");
        templateBuilder.Append("      </tr>\r\n      ");
        DataSet ls1 = get_cart_listNew();
        foreach (DataRow row in ls1.Tables[0].Rows)
        {
            ...
            templateBuilder.Append("\r\n      <tr>\r\n        <td><a target=\"_blank\" href=\"");
            templateBuilder.Append(linkurl("goods_show", row["id"]));

            templateBuilder.Append("\"><img src=\"");
            templateBuilder.Append(row["img_url"]);
            templateBuilder.Append("\" class=\"img\" /></a></td>\r\n        <td><a target=\"_blank\" href=\"");
            templateBuilder.Append(linkurl("goods_show", row["id"].ToString()));
	...
	templateBuilder.Append("\">马上去购物</a>吧！</p>\r\n            </div>\r\n          </div>\r\n        </td>\r\n      </tr>\r\n      ");
        ...
        else
        {
            ...
            templateBuilder.Append("订单数：<font color=\"#FF0000\">");
            templateBuilder.Append(Utils.ObjectToStr(cartModel.order_quantity));
            templateBuilder.Append("</font> 个 &nbsp; &nbsp;&nbsp;");
    ...
    templateBuilder.Append("\">" + Resources.lang.returns + "</a>\r\n      ");
    if (ls1.Tables[0].Rows.Count > 0)
	{

        templateBuilder.Append("\r\n      <input id=\"btnSubmit\" name=\"btnSubmit\" type=\"submit\" value=\"" + Resources.lang.Submits + "\" class=\"btn btn-success marL10\" />\r\n      ");
	}
	else
	{

        templateBuilder.Append("\r\n      <a class=\"btn btn-gray marL10\">" + Resources.lang.Submits + "</a>\r\n      ");
	}	//end for if
