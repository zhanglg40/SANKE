...
namespace Web.admin.article
{
    public partial class article_list : Web.UI.ManagePage
    {
        ...
        private void RptBind(int _channel_id, int _category_id,string _strWhere, string _orderby)
        {
            ...
            switch (this.prolistview)
            {
                ...
                default:
                    ...
                    if (_channel_id == 2)
                    this.rptList2.DataSource = bll.GetListNew(_channel_id, _category_id, this.pageSize, this.page, _strWhere, _orderby, out this.totalCount);
                    else this.rptList2.DataSource = bll.GetList(_channel_id, _category_id, this.pageSize, this.page, _strWhere, _orderby, out this.totalCount);
        ...
        protected string CombSqlTxt(string _keywords, string _property)
        {
            ...
            {
                strTemp.Append(" and title like '%" + _keywords + "%' or goods_no='" + _keywords + "' or Barcode  like '%" + _keywords + "%'");
            }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(AXEnums.ActionEnum.Edit.ToString(), "保存" + this.channel_name + "频道内容排序"); //记录日志
        ...
        {
            ChkAdminLevel("channel_" + this.channel_name + "_list", AXEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0; //成功数量
            ...
            AddAdminLog(AXEnums.ActionEnum.Edit.ToString(), "删除" + this.channel_name + "频道内容成功" + sucCount + "条，失败" + errorCount + "条"); //记录日志
