...
<table style="width:100%;border: solid 1px #EEEEE0;border-collapse:collapse; "  class="ltable">
  <tr>
    ...
    <th style="width:30%;text-align:center">商店</th>
...
<!--/文字列表-->
    ...
    <asp:Button ID="btnSubmit" style="display:none;" runat="server" Text="提交保存" CssClass="btn"  onclick="btnAdd_Click" />
