...
namespace Web.UI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        /// <summary>
        /// 返回" + Resources.lang.commodity+ "列表
        /// </summary>
        ...
        protected string get_order_status(int _id)
        {
            ...
            switch (model.status)
            {
                case 1: //如果是线下支付，支付状态为0，如果是线上支付，支付成功后会自动改变" + Resources.lang.orderStatus+ "为已确认
                    if (model.payment_status > 0)
                    {
                       
                        _title = "待付款";
                         if ("pl-PL".Equals(lang))
                             _title = "Do czasu płatności";
                    }
                    else
                    {
                        _title = "待确认";
                ...
                case 4:
                    _title = "已取消";
                    if ("pl-PL".Equals(lang))
                        _title = "Został anulowany";
                    break;
                case 5:
                    _title = "已作废";
                    if ("pl-PL".Equals(lang))
                        _title = "Była przestarzała";
                    break;
            }
