...
namespace Web.UI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        /// <param name="parent_id">父类别ID</param>
        /// <returns>DataTable</returns>
        protected DataTable get_category_child_listpp(int Top, string channel_name, int parent_id, int category_id)
        {
            return new BLL.article_category().GetChildListpp(Top, parent_id, channel_name, category_id);
        }
