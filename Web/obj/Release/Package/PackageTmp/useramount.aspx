<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.UI.Page.useramount" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
   ...
   */
    ...
    if (action == "recharge")
    {
        ...
        if (lang.Equals("pl-PL"))
        {
            templateBuilder.Append("\">Ładowanie konta</a></li>\r\n        <li><a href=\"");
            templateBuilder.Append(linkurl("useramount", "list"));

            templateBuilder.Append("\">Szczegóły</a></li>\r\n      </ul>\r\n    </div>\r\n    <h3>Kwota bieżącego konta wynosi：<b class=\"red\">");
        }
        else
        {
        ...
        templateBuilder.Append("</b> PLN</h3>\r\n    <form id=\"recharge_form\" name=\"recharge_form\" url=\"");
        templateBuilder.Append(Utils.ObjectToStr(config.webpath));
        if (lang.Equals("pl-PL"))
        {
            templateBuilder.Append("tools/submit_ajax.ashx?action=user_amount_recharge\">\r\n    <div class=\"form_box\">\r\n      <dl>\r\n        <dt>Kwota doładowania：</dt>\r\n        <dd><input name=\"order_amount\" id=\"order_amount\" type=\"text\" class=\"input small\" style=\"ime-mode:disabled;\" datatype=\"n\"  nullmsg=\"Wprowadź kwotę\" sucmsg=\" \" /> PLN</dd>\r\n      </dl>\r\n      <dl>\r\n        <dt>Metoda płatności：</dt>\r\n        ");
        }
        else
        {
            templateBuilder.Append("tools/submit_ajax.ashx?action=user_amount_recharge\">\r\n    <div class=\"form_box\">\r\n      <dl>\r\n        <dt>充值金额：</dt>\r\n        <dd><input name=\"order_amount\" id=\"order_amount\" type=\"text\" class=\"input small\" style=\"ime-mode:disabled;\" datatype=\"n\"  nullmsg=\"请输入金额\" sucmsg=\" \" /> PLN</dd>\r\n      </dl>\r\n      <dl>\r\n        <dt>支付方式：</dt>\r\n        ");
        ...
        if (lang.Equals("pl-PL"))
        {
            templateBuilder.Append("\r\n      </dl>\r\n      <dl>\r\n        <dt></dt>\r\n        <dd><input name=\"btnSubmit\" id=\"btnSubmit\" type=\"submit\" class=\"btn_submit\" value=\"Potwierdź ładowanie\" /></dd>\r\n      </dl>\r\n    </div>\r\n    </form>\r\n    <!--账户充值-->\r\n    \r\n    ");
        }
        else
        {
