<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="center.aspx.cs" Inherits="Web.admin.center" %>
...
<div class="location">
  ...
  <a class="home"><i></i><asp:Literal runat="server" Text="<%$ Resources:lang,home%>" /></a>
  <i class="arrow"></i>
  <span>管理中心</span>
</div>
<!--/导航栏-->
