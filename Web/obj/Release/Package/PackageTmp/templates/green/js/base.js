...
//执行删除" + Resources.lang.operating+ "
function ExecDelete(sendUrl, checkValue, urlId){
	var urlObj = $('#' + urlId);
	//检查传输的值
	if (!checkValue) {
		$.dialog.alert("对不起，请选中您要" + Resources.lang.operating+ "的记录！");
        return false;
	}
...
//单击执行AJAX请求" + Resources.lang.operating+ "
...
function SendEmail(username, sendurl) {
	if(username == ""){
		$.dialog.alert('对不起，" + Resources.lang.username+ "不允许为空！');
		return false;
	}
	//提交
	$.ajax({
