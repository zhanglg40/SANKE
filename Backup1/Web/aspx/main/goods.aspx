<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.UI.Page.article" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by AoXiang Template Engine at 2016-04-26 上午 10:05:12.
		本页面代码由AoXiang模板引擎生成于 2016-04-26 上午 10:05:12. 
	*/
	...
	templateBuilder.Append("\">首页 </a>> 积分商城</span>\r\n        </dd>\r\n      </dl>\r\n      <div class=\"pro_list\">\r\n        <ul>\r\n          ");
	DataTable goods_list = get_article_list("down", 0, 16, "status=0 and channel_id=4");

	foreach(DataRow dr in goods_list.Rows)
	{

	templateBuilder.Append("\r\n          <li>\r\n            <a class=\"pic\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\"><img src=\"" + Utils.ObjectToStr(dr["img_url"]) + "\" alt=\"" + Utils.ObjectToStr(dr["title"]) + "\" /></a>\r\n            <div class=\"info\">\r\n              <a class=\"name\"  title=\"" + Utils.ObjectToStr(dr["title"]) + "\">" + Utils.ObjectToStr(dr["title"]) + "</a>\r\n              <div class=\"price\">\r\n                <span>积分：</span>\r\n                <strong>￥" + Utils.ObjectToStr(dr["point"]) + "</strong>\r\n              </div>\r\n            </div>\r\n          </li>\r\n          ");
	}	//end for if

	templateBuilder.Append("\r\n        </ul>\r\n      </div>\r\n      \r\n    </div>\r\n    <!--/Content-->\r\n  </div>\r\n  \r\n  <div class=\"left264\">\r\n    <!--Sidebar-->\r\n    <div class=\"sidebar\">\r\n      <h3>商品类别</h3>\r\n      <ul class=\"navbar\">\r\n        ");
	DataTable category_list28 = get_category_child_list("goods", 0);

	int cdr28__loop__id=0;
	foreach(DataRow cdr28 in category_list28.Rows)
	{
		cdr28__loop__id++;


	templateBuilder.Append("\r\n        <li>\r\n          <h4><a href=\"");
	templateBuilder.Append(linkurl("goods_list",Utils.ObjectToStr(cdr28["id"])));

	templateBuilder.Append("\">" + Utils.ObjectToStr(cdr28["title"]) + "</a></h4>\r\n          <div class=\"list\">\r\n            ");
	DataTable category_list29 = get_category_child_list("goods", Utils.StrToInt(Utils.ObjectToStr(cdr28["id"]), 0));

	int cdr29__loop__id=0;
	foreach(DataRow cdr29 in category_list29.Rows)
	{
		cdr29__loop__id++;


	templateBuilder.Append("\r\n            <a href=\"");
	templateBuilder.Append(linkurl("goods_list",Utils.ObjectToStr(cdr29["id"])));

	templateBuilder.Append("\">" + Utils.ObjectToStr(cdr29["title"]) + "</a>\r\n            ");
	}	//end for if
