...
override protected void OnInit(EventArgs e)
{
   ...
   */
	...
	if (action=="succeed")
	{
        ...
        templateBuilder.Append("\r\n    <!--支付成功-->\r\n    <div class=\"msg_tips\">\r\n      <div class=\"ico\"></div>\r\n      <div class=\"msg\">\r\n        <strong>" + Resources.lang.successful + "！</strong>\r\n        ");
        if (lang.Equals("pl-PL"))
        {
            templateBuilder.Append("      <p>Kliknij tutaj, aby <a href=\"");
            templateBuilder.Append(linkurl("usercenter", "index"));

            templateBuilder.Append("\">" + Resources.lang.membercentre + "</a> wyświetl stan zamówienia！</p>");
        }
        else
        {
            templateBuilder.Append("<p>恭喜您，您的支付已经成功！</p>\r\n        <p>您可以点击这里进入<a href=\"");
            templateBuilder.Append(linkurl("usercenter", "index"));
