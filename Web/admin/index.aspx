    ...
    <div class="nav-right">
      <div class="icon-info">
        <span>
          ...
          <%=new BLL.manager_role().GetTitle(admin_info.role_id) %>
        </span>
      </div>
      <div class="icon-option">
        ...
        <div class="drop-box">
          ...
          <ul class="drop-item">
            ...
            <li><a onclick="linkMenuTree(false, '');" href="manager/manager_pwd.aspx" target="mainframe"><asp:Literal runat="server" Text="<%$ Resources:lang,changePSD%>" /></a></li>
