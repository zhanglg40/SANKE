...
override protected void OnInit(EventArgs e)
{
   ...
   */
    ...
    templateBuilder.Append("\">" + Resources.lang.shopm+ "</a></li>\r\n        <li><a href=\"");
    templateBuilder.Append("/shoplist.aspx");
    ...
    templateBuilder.Append("\r\n        </td>\r\n        <td align=\"center\">" + Utils.ObjectToStr(dr["accept_name"]) + "</td>\r\n        <td align=\"center\"><strong>" + Utils.ObjectToStr(dr["order_amount"]) + " PLN</strong><br />");
	...
	templateBuilder.Append(Utils.ObjectToStr(config.webpath));
	templateBuilder.Append("tools/submit_ajax.ashx?action=order_cancel&order_no=" + Utils.ObjectToStr(dr["order_no"]) + "');\">"+Resources.lang.cancel+"</a>\r\n          ");
	}	//end for if
