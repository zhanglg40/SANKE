...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	//templateBuilder.Append(Utils.ObjectToStr(config.webkeyword) + "111");
    ...
    templateBuilder.Append("<link media=\"screen\" type=\"text/css\" rel=\"stylesheet\"  href=\"");
	templateBuilder.Append("/templates/green");
   ...
   */
    ...
    templateBuilder.Append("\r\n<!--/Header-->\r\n\r\n		<div class=\"contentmainbox\">\r\n			<div id=\"display_containers\" style=\"height:2300px;\">\r\n		\r\n        ");
    /*
    templateBuilder.Append("<div class=\"plugin_containers\" style=\"left: 0px; top: 0px; width: 196px; height: 350px; z-index: 10;\" layout_id=\"11402904\" plugin_type=\"5\" plugin_data_show_title=\"1\" plugin_data_style=\"1\" plugin_data_type=\"0\" x=\"0\" y=\"0\" cx=\"1\" cy=\"7\">\r\n		<div class=\"plugin_body\" style=\"width:196px;height:350px;\">\r\n					<div class=\"plugin_untitle_border patt_border_plugin_untitle\" style=\"width: 174px; height: 328px;\">\r\n						<div class=\"plugin_inner_content\" style=\"width: 174px; height: 328px;\">\r\n					<div class=\"nav_style1_main_content\">\r\n						<ul class=\"nav_style1_content nav_style1_color1\" style=\"cursor: default;\">\r\n\r\n          ");
	...
	templateBuilder.Append("\r\n												<em><a class=\"class3\" class3_id=\"10020\" target=\"_parent\" href=\"");
    ...
    templateBuilder.Append("\r\n							\r\n					</div>\r\n</div>\r\n					</div>\r\n		</div>\r\n		</div>\r\n		");
   */
    templateBuilder.Append("<div class=\"plugin_containers\" style=\"left:0px;top:0px;width:906px;height:350px;\" layout_id=\"11402905\" plugin_type=\"0\" plugin_data_show_title=\"0\" plugin_data_style=\"1\" plugin_data_type=\"0\" x=\"1\" y=\"0\" cx=\"1\" cy=\"7\">\r\n		<div class=\"plugin_body\" style=\"width:906px;height:350px;\">\r\n					<div class=\"plugin_untitle_noborder\" style=\"width: 896px; height: 340px;\">\r\n						<div class=\"plugin_inner_content\" style=\"width: 960px; height: 340px;\">\r\n		<div class=\"plugin_advertising_content\" direction=\"1\" interval=\"2000\">\r\n				<div class=\"slideshow\" style=\"width: 7000px; height: 340px;\">\r\n					<div class=\"caroufredsel_wrapper\" style=\"display: block; text-align: start; float: none; position: absolute; top: 0px; right: auto; bottom: auto; left: auto; z-index: 0; width: 960px; height: 340px; margin: 0px; overflow: hidden;\"><ul class=\"slides\" style=\"text-align: left; float: none; position: absolute; top: 0px; right: auto; bottom: auto; left: 0px; margin: 0px; width: 6300px; height: 340px; z-index: 0;\">											\r\n	     ");
	...
	templateBuilder.Append("\r\n                	<li style=\"width: 960px; height: 340px;\"><a href=\"" + Utils.ObjectToStr(dr["link_url"]) + "\" target=\"_blank\"><img class=\"lazy adv_image\" index=\"1\" src=\"" + Utils.ObjectToStr(dr["img_url"]) + "\" data-original=\"" + Utils.ObjectToStr(dr["img_url"]) + "\" style=\"width: 700px; height: 340px; display: inline;\"></a></li>\r\n          ");
	}	//end for if
   ...
   /*
    ...
    templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\">" + Utils.ObjectToStr(dr["title"]) + "</a></p></div>\r\n					<p class=\"showcase_goods_style0_rmb\">\r\n						<strong>现价： <em id=\"Em1\">" + Utils.ObjectToStr(dr["sell_price"]) + "</em> PLN</strong>\r\n					</p>\r\n				</div>\r\n	</li>\r\n       ");
	}	//end for if
  ...
  */
    ...
    templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\">" + Utils.ObjectToStr(dr["title"]) + "</a></p></div>\r\n					<div class=\"a_text_dd\"><strong><em id=\"Em10\">" + Utils.ObjectToStr(dr["sell_price"]) + "</em> PLN</strong></div>\r\n				</div>\r\n			</div>\r\n	</li>\r\n      ");
	}	//end for if
    ...
    templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\">" + Utils.ObjectToStr(dr["title"]) + "</a></p></div>\r\n					<div class=\"a_text_dd\"><strong> <em id=\"Em7\">" + Utils.ObjectToStr(dr["sell_price"]) + "</em> PLN</strong></div>\r\n				</div>\r\n			</div>\r\n	</li>\r\n      ");
	}	//end for if

	templateBuilder.Append("\r\n	\r\n</ul>\r\n		</div>\r\n</div>\r\n				</div>\r\n			</div>\r\n		</div>\r\n		</div>\r\n	");
   */
    templateBuilder.Append("	<div class=\"plugin_containers\" style=\"left:0px;top:340px;width:1200px;height:1510px;\" layout_id=\"11402911\" plugin_type=\"2\" plugin_data_show_title=\"3\" plugin_data_style=\"0\" plugin_data_type=\"0\" x=\"1\" y=\"23\" cx=\"1\" cy=\"11\">\r\n		");
    templateBuilder.Append("<div class=\"plugin_body\" style=\"width:1200px;height:1900px;\">\r\n			<div class=\"plugin_title_border patt_border_plugin_title\" style=\"width: 698px; height: 758px;\">\r\n				<div class=\"plugin_title_pic bg_a patt_bg_plugin_title\">\r\n					<div class=\"plugin_title patt_font_plugin_title\">"+Resources.lang.goodlist+"</div>\r\n						<ul class=\"plugin_title_searchkey\">\r\n						</ul>\r\n				</div>\r\n				<div class=\"plugin_inner_border\">\r\n					<div class=\"plugin_inner_content\" style=\"width: 688px; height: 650px;\">\r\n		<div class=\"showcase_main_content\" goods_style=\"0\" roll=\"False\" direction=\"2\" interval=\"2000\">\r\n			<ul class=\"showcase_type0_goods\">\r\n\r\n      ");

    //商品列表
    DataTable goodsf1 = view_goods(page, out  totalcount, out  pagelist);
 //   DataTable goodsf1 = get_article_listpp("goods", category_id, vote_id, page, "status=0", out totalcount, out pagelist, "goods_list", category_id, "__id__");

   
	foreach(DataRow dr in goodsf1.Rows)
	{

        templateBuilder.Append("\r\n        <li  label_id=\"0\" goods_id=\"" + Utils.ObjectToStr(dr["id"]) + "\" RuleId=\"" + Utils.ObjectToStr(dr["id"]) + "\" RuleType=\"\" RuleStartTime=null RuleEndTime=null Price=\"" + Utils.ObjectToStr(dr["sell_price"]) + "\" DiscountPrice=\"\" style=\"padding: 12px 13px 8px 13px;padding-left:10px;\">\r\n				");
        templateBuilder.Append("<div class=\"showcase_goods_style0\" style=\" text-overflow:ellipsis;overflow:\">\r\n					<div class=\"showcase_goods_style0_img\">\r\n						<a target=\"_blank\" href=\"");
	templateBuilder.Append(linkurl("goods_show",Utils.ObjectToStr(dr["id"])));

	templateBuilder.Append("\"><img class=\"lazy\" src=\"" + Utils.ObjectToStr(dr["img_url"]) + "\" alt=\"");
    if (lang.Equals("pl-PL"))
    {
        templateBuilder.Append(Utils.ObjectToStr(dr["english_name"]));
    }
    else
    {
        templateBuilder.Append(Utils.ObjectToStr(dr["title"]));
    }

    templateBuilder.Append("\"  data-original=\"" + Utils.ObjectToStr(dr["img_url"]) + "\" style=\"width: 166px; height: 166px; margin-left: 0px; margin-top: 0px; display: inline;\"></a>\r\n						<div id=\"sales_icon\"><div class=\"sales_reduce\"></div></div>\r\n					</div>\r\n					<div class=\"showcase_goods_style0_intro\"><p class=\"nav_p_hover\"><a target=\"_blank\" style=\" white-space:nowrap;\" href=\"");
	templateBuilder.Append(linkurl("goods_show",Utils.ObjectToStr(dr["id"])));
   
   
    if (lang.Equals("pl-PL"))
    {
        templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["english_name"]) + "\">" + Utils.ObjectToStr(dr["english_name"]));
        templateBuilder.Append("</a></p>");
       
    }
    else
    {
        templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\">" + Utils.ObjectToStr(dr["title"]));
        templateBuilder.Append("</a></p>");
      
    }

    templateBuilder.Append("</div>\r\n			<p class=\"showcase_goods_style0_rmb\"><strong>" + Resources.lang.Barcode + " <em id=\"Em21\">" + Utils.ObjectToStr(dr["Barcode"]) + "</em> </strong>\r\n</p>		<p class=\"showcase_goods_style0_rmb\">\r\n						<strong>" + Resources.lang.price + ": <em id=\"price" + Utils.ObjectToStr(dr["id"]) + "\">" + Utils.ObjectToStr(dr["sell_price"]) + "</em> PLN</strong>\r\n					</p>\r\n	");
    templateBuilder.Append("<p class=\"showcase_goods_style0_rmb\">\r\n						<strong>" + Resources.lang.inventory + "： <em id=\"Em21" + Utils.ObjectToStr(dr["id"]) + "\">" + Utils.ObjectToStr(dr["stock_quantity"]) + "</em> </strong>\r\n					</p>\r\n");

    templateBuilder.Append(" <div class=\"pro-btns\">\r\n		  <div class=\"input-box\">\r\n              "+Resources.lang.buycount+"：");
    templateBuilder.Append("<input name=\"goods_price\" id=\"goods_price" + Utils.ObjectToStr(dr["id"]) + "\" type=\"hidden\" value=\"");
    templateBuilder.Append(Utils.ObjectToStr(dr["sell_price"]));
    templateBuilder.Append("\" /><input name=\"goods_count\" id=\"goods_count" + Utils.ObjectToStr(dr["id"]) + "\" type=\"hidden\" value=\"");
    templateBuilder.Append(Utils.ObjectToStr(dr["stock_quantity"]));
    templateBuilder.Append("\" /><input name=\"goods_id\" id=\"goods_id\" type=\"hidden\" value=\"");
    templateBuilder.Append(Utils.ObjectToStr(dr["id"]));
    templateBuilder.Append("\" /><input type=\"text\" name=\"goods_quantity\" id=\"goods_quantity");
    templateBuilder.Append(Utils.ObjectToStr(dr["id"]));  
    templateBuilder.Append("\" value=\"\" class=\"txt\" style=\"ime-mode:disabled\" />\r\n          </div>\r\n          <div class=\"btn-box\">\r\n            ");
    if (Utils.StrToInt(Utils.ObjectToStr(dr["stock_quantity"]), 0) > 0)
    {
        if (count == 0)
        {
            templateBuilder.Append("\r\n            <a id=\"zzz" + Utils.ObjectToStr(dr["id"]) + "\" href=\"javascript:void(0);\" class=\"");
            if (lang.Equals("pl-PL"))
            {
            ...
            templateBuilder.Append("\" onclick=\"CartAddNew(this, '");
            templateBuilder.Append(Utils.ObjectToStr(dr["id"]));
            templateBuilder.Append("','");
            templateBuilder.Append(Utils.ObjectToStr(config.webpath));
    ...
    else
    {
        if (lang.Equals("pl-PL"))
        {
            templateBuilder.Append("\r\n            <a title=\"Ścisła dostawy towarów, nie Dodaj do koszyka\" class=\"add-over2\">" + Resources.lang.addcart + "</a>\r\n                   ");
        }
        else
        {
    ...
    */
    ...
    templateBuilder.Append("script>\r\n</div>\r\n				</div>\r\n</div>\r\n				</div>\r\n			</div>\r\n		</div>\r\n		</div>\r\n		\r\n  ");
    */
    templateBuilder.Append("      <div class=\"plugin_containers\" style=\"left:906px;top:0px;width:294px;height:150px;\" layout_id=\"11402914\" plugin_type=\"1\" plugin_data_show_title=\"0\" plugin_data_style=\"1\" plugin_data_type=\"1\" x=\"2\" y=\"0\" cx=\"1\" cy=\"3\">\r\n		<div class=\"plugin_body\" style=\"width:294px;height:150px;\">\r\n					<div class=\"plugin_untitle_noborder\" style=\"width: 284px; height: 140px;\">\r\n						<div class=\"plugin_inner_content\" style=\"width: 284px; height: 140px;\">\r\n ");
...
//右上测公告栏       
    templateBuilder.Append("<div class=\"plugin_containers\" style=\"left:906px;top:150px;width:294px;height:200px;\" layout_id=\"11402915\" plugin_type=\"8\" plugin_data_show_title=\"3\" plugin_data_style=\"0\" plugin_data_type=\"0\" x=\"2\" y=\"3\" cx=\"1\" cy=\"4\">\r\n		<div class=\"plugin_body\" style=\"width:294px;height:200px;\">\r\n			<div class=\"plugin_title_border patt_border_plugin_title\" style=\"width: 282px; height: 188px;\">\r\n				<div class=\"plugin_title_pic bg_a patt_bg_plugin_title\">\r\n					<div class=\"plugin_title patt_font_plugin_title\">"+Resources.lang.announcement+"</div>\r\n				</div>\r\n				<div class=\"plugin_inner_border\">\r\n					<div class=\"plugin_inner_content\" style=\"width: 272px; height: 140px;\">\r\n		<div class=\"plugin_news_main_content\" roll=\"False\" direction=\"2\" interval=\"2000\" style=\"height: 125px;\">\r\n				<div class=\"text_news_style0_content\">\r\n					<ul class=\"text_news_list\">\r\n                      ");
    ...
    templateBuilder.Append("\r\n					</ul>\r\n				</div>\r\n		</div>\r\n</div>\r\n				</div>\r\n			</div>\r\n		</div>\r\n		</div>\r\n\r\n		");
   /*
    templateBuilder.Append("<div class=\"plugin_containers\" style=\"left:0px;top:1200px;width:1200px;height:100px;\" layout_id=\"11402916\" plugin_type=\"1\" plugin_data_show_title=\"1\" plugin_data_style=\"1\" plugin_data_type=\"1\" x=\"0\" y=\"34\" cx=\"3\" cy=\"2\">\r\n		<div class=\"plugin_body\" style=\"width:1200px;height:100px;\">\r\n					<div class=\"plugin_untitle_border patt_border_plugin_untitle\" style=\"width: 1178px; height: 78px;\">\r\n						<div class=\"plugin_inner_content\" style=\"width: 1178px; height: 78px;\">\r\n\r\n           ");
  ...
  /*  templateBuilder.Append("	</div>\r\n		</div>\r\n\r\n		<div class=\"plugin_containers\" style=\"left:196px;top:1300px;width:710px;height:550px;\" layout_id=\"11402917\" plugin_type=\"2\" plugin_data_show_title=\"3\" plugin_data_style=\"0\" plugin_data_type=\"0\" x=\"1\" y=\"36\" cx=\"1\" cy=\"11\">\r\n		<div class=\"plugin_body\" style=\"width:710px;height:550px;\">\r\n			<div class=\"plugin_title_border patt_border_plugin_title\" style=\"width: 698px; height: 538px;\">\r\n				<div class=\"plugin_title_pic bg_a patt_bg_plugin_title\">\r\n					<div class=\"plugin_title patt_font_plugin_title\">五金用品</div>\r\n						<ul class=\"plugin_title_searchkey\">\r\n						</ul>\r\n				</div>\r\n				<div class=\"plugin_inner_border\">\r\n					<div class=\"plugin_inner_content\" style=\"width: 688px; height: 490px;\">\r\n		<div class=\"showcase_main_content\" goods_style=\"0\" roll=\"False\" direction=\"2\" interval=\"2000\">\r\n			<ul class=\"showcase_type0_goods\">	\r\n            \r\n      ");
    ...
    templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\">" + Utils.ObjectToStr(dr["title"]) + "</a></p></div>\r\n					<p class=\"showcase_goods_style0_rmb\">\r\n						<strong>现价： <em id=\"Em23\">" + Utils.ObjectToStr(dr["sell_price"]) + "</em> PLN</strong>\r\n					</p>\r\n				</div>\r\n	</li>\r\n\r\n      ");
	}	//end for if
    ...
    /*   templateBuilder.Append("	<div class=\"plugin_containers\" style=\"left:906px;top:1300px;width:294px;height:550px;\" layout_id=\"11402918\" plugin_type=\"1\" plugin_data_show_title=\"1\" plugin_data_style=\"1\" plugin_data_type=\"7\" x=\"2\" y=\"36\" cx=\"1\" cy=\"11\">\r\n		<div class=\"plugin_body\" style=\"width:294px;height:550px;\">\r\n					<div class=\"plugin_untitle_border patt_border_plugin_untitle\" style=\"width: 272px; height: 528px;\">\r\n						<div class=\"plugin_inner_content\" style=\"width: 272px; height: 528px;\">\r\n						<div class=\"image_type7_gap\">\r\n							<div class=\"image_type7_bigimg li1\" style=\"width:270px;height:337px;\">\r\n           ");
       ...
       templateBuilder.Append("\r\n							</ul>\r\n						</div>\r\n</div>\r\n					</div>\r\n		</div>\r\n		</div>\r\n	\r\n    	");
       templateBuilder.Append("<div class=\"plugin_containers\" style=\"left:0px;top:1300px;width:196px;height:550px;\" layout_id=\"11402910\" plugin_type=\"4\" plugin_data_show_title=\"3\" plugin_data_style=\"2\" plugin_data_type=\"0\" x=\"0\" y=\"23\" cx=\"1\" cy=\"11\">\r\n		<div class=\"plugin_body\" style=\"width:196px;height:550px;\">\r\n			<div class=\"plugin_title_border patt_border_plugin_title\" style=\"width: 184px; height: 538px;\">\r\n				<div class=\"plugin_title_pic bg_a patt_bg_plugin_title\">\r\n					<div class=\"plugin_title patt_font_plugin_title\">精选推荐</div>\r\n				</div>\r\n				<div class=\"plugin_inner_border\">\r\n					<div class=\"plugin_inner_content\" style=\"width: 174px; height: 490px;\">\r\n		<div class=\"showcase_main_content\" goods_style=\"0\" roll=\"False\" direction=\"2\" interval=\"2000\">\r\n			<ul class=\"showcase_type2_goods\">\r\n            \r\n          ");
       //第二个推荐
       DataTable goodsf12 = get_article_list("goods", 137, 3, "is_top=1","add_time desc");
       ...
       templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\">" + Utils.ObjectToStr(dr["title"]) + "</a></p></div>\r\n					<div class=\"a_text_dd\"><strong> <em id=\"Em3\">" + Utils.ObjectToStr(dr["sell_price"]) + "</em> PLN</strong></div>\r\n				</div>\r\n			</div>\r\n	</li>\r\n      ");
       }	//end for if
       ...
       templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\">" + Utils.ObjectToStr(dr["title"]) + "</a></p></div>\r\n					<div class=\"a_text_dd\"><strong> <em id=\"Em6\">" + Utils.ObjectToStr(dr["sell_price"]) + "</em>PLN</strong></div>\r\n				</div>\r\n			</div>\r\n	</li>\r\n      ");
       }	//end for if
       ...
       templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\">" + Utils.ObjectToStr(dr["title"]) + "</a></p></div>\r\n					<p class=\"showcase_goods_style0_rmb\">\r\n						<strong>现价： <em id=\"Em8\">" + Utils.ObjectToStr(dr["sell_price"]) + "</em>PLN</strong>\r\n					</p>\r\n				</div>\r\n	</li>\r\n\r\n      ");
       }	//end for if
       ...
       templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\">" + Utils.ObjectToStr(dr["title"]) + "</a></p></div>\r\n					<p class=\"showcase_goods_style0_rmb\">\r\n						<strong>现价： <em id=\"Em9\">" + Utils.ObjectToStr(dr["sell_price"]) + "</em>PLN</strong>\r\n					</p>\r\n				</div>\r\n	</li>\r\n\r\n\r\n      ");
       }	//end for if

       templateBuilder.Append("\r\n\r\n\r\n</ul>\r\n		</div>\r\n</div>\r\n				</div>\r\n			</div>\r\n		</div>\r\n		</div>\r\n		");
       /*
       templateBuilder.Append("<div class=\"plugin_containers\" style=\"left:906px;top:1850px;width:294px;height:550px;\" layout_id=\"11402918\" plugin_type=\"1\" plugin_data_show_title=\"1\" plugin_data_style=\"1\" plugin_data_type=\"7\" x=\"2\" y=\"36\" cx=\"1\" cy=\"11\">\r\n		<div class=\"plugin_body\" style=\"width:294px;height:550px;\">\r\n					<div class=\"plugin_untitle_border patt_border_plugin_untitle\" style=\"width: 272px; height: 528px;\">\r\n						<div class=\"plugin_inner_content\" style=\"width: 272px; height: 528px;\">\r\n						<div class=\"image_type7_gap\">\r\n							<div class=\"image_type7_bigimg li1\" style=\"width:270px;height:337px;\">\r\n		 ");
       ...
       templateBuilder.Append("\r\n							</ul>\r\n						</div>\r\n</div>\r\n					</div>\r\n		</div>\r\n		</div>\r\n	");
       templateBuilder.Append("	<div class=\"plugin_containers\" style=\"left:0px;top:1850px;width:196px;height:550px;\" layout_id=\"11402910\" plugin_type=\"4\" plugin_data_show_title=\"3\" plugin_data_style=\"2\" plugin_data_type=\"0\" x=\"0\" y=\"23\" cx=\"1\" cy=\"11\">\r\n		<div class=\"plugin_body\" style=\"width:196px;height:550px;\">\r\n			<div class=\"plugin_title_border patt_border_plugin_title\" style=\"width: 184px; height: 538px;\">\r\n				<div class=\"plugin_title_pic bg_a patt_bg_plugin_title\">\r\n					<div class=\"plugin_title patt_font_plugin_title\">精选推荐</div>\r\n				</div>\r\n				<div class=\"plugin_inner_border\">\r\n					<div class=\"plugin_inner_content\" style=\"width: 174px; height: 490px;\">\r\n		<div class=\"showcase_main_content\" goods_style=\"0\" roll=\"False\" direction=\"2\" interval=\"2000\">\r\n			<ul class=\"showcase_type2_goods\">	\r\n            \r\n            ");
       ...
       templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\">" + Utils.ObjectToStr(dr["title"]) + "</a></p></div>\r\n					<div class=\"a_text_dd\"><strong> <em id=\"Em4\">" + Utils.ObjectToStr(dr["sell_price"]) + "</em>PLN</strong></div>\r\n				</div>\r\n			</div>\r\n	</li>\r\n      ");
       }	//end for if
       ...
       templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\">" + Utils.ObjectToStr(dr["title"]) + "</a></p></div>\r\n					<div class=\"a_text_dd\"><strong> <em id=\"Em5\">" + Utils.ObjectToStr(dr["sell_price"]) + "</em>PLN</strong></div>\r\n				</div>\r\n			</div>\r\n	</li>\r\n      ");
       }	//end for if
    ...
    templateBuilder.Append("<!--滑动门js-s-->\r\n<script src=\"");
	templateBuilder.Append("/templates/green");
