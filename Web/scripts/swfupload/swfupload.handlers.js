$(function () {
    ...
    $.fn.InitSWFUpload = function (p) {
        ...
        var swfu = new SWFUpload({
            ...
            button_text_top_padding: 5, //按钮的上边距
            button_width: p.btnwidth, //上传按钮的宽度
            button_height: p.btnheight, //上传按钮的高度
         //   button_image_url: "../../css/image1.gif", //按钮背景图片路径
...
function addImage(targetObj, originalSrc, thumbSrc) {
    ...
    + '<a href="javascript:;" onclick="delImg(this);">" + Resources.lang.delete+ "</a>'
    + '</li>');
