<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_channel.aspx.cs" Inherits="Web.admin.dialog.dialog_channel" %>
...
<script type="text/javascript">
    ...
    function getTrHtml() {
		...
		+ '<td><a title="编辑" class="img-btn edit operator" onclick="showChannelDialog(this);"><asp:Literal runat="server" Text="<%$ Resources:lang,edit%>" /></a> '
        + '<a title="删除" class="img-btn del operator" onclick="delItemTr(this);"><asp:Literal runat="server" Text="<%$ Resources:lang,delete%>" /></a></td>'
		+ '</tr>';
        return navRow;
    }
    ...
    function createUrlHtml() {
        var trHtml = '<tr class="td_c">'
            ...
            + '<td>'
            + '<i class="icon"></i>'
            + '<a title="编辑" class="img-btn edit operator" onclick="showUrlDialog(this);"><asp:Literal runat="server" Text="<%$ Resources:lang,edit%>" /></a>'
            + '<a title="删除" class="img-btn del operator" onclick="delUrlNode(this);"><asp:Literal runat="server" Text="<%$ Resources:lang,delete%>" /></a>'
            + '</td>'
            + '</tr>'
        return trHtml;
    }
  ...
  <dl>
    ...
    <dd>
      <select id="pageType" class="select">
        ...
        <option value="index">"+Resources.lang.home+"</option>
