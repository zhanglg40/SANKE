<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.UI.Page.search" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
    ...
    templateBuilder.Append("/templates/green");
    templateBuilder.Append("/images/zlg.css\">\r\n<link media=\"screen\" type=\"text/css\" rel=\"stylesheet\"  href=\"");
	templateBuilder.Append("/templates/green");
	...
	if (dr["name"].ToString()=="goods")
	{
        ...
        templateBuilder.Append(" <div style=\"float:left; width:18%\"><a   href=\"" + Utils.ObjectToStr(dr["link_url"]) + "\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\"><img  style=\"width: 152px;height: 152px;\" src=\"" + Utils.ObjectToStr(dr["img_url"]) + "\" alt=\"" + Utils.ObjectToStr(dr["title"]) + "\"></a></div>\r\n           ");
        templateBuilder.Append(" <div style=\"float:left; width:25%; margin-left:20px\">\r\n             <p><a target=\"_blank\" href=\"" + Utils.ObjectToStr(dr["link_url"]) + "\">" + Utils.ObjectToStr(dr["title"]) + "</a><span>( "); templateBuilder.Append(Utils.ObjectToDateTime(Utils.ObjectToStr(dr["add_time"])).ToString("yyyy-MM-dd"));

        templateBuilder.Append(" )</span></p>\r\n             <p>" + Utils.ObjectToStr(dr["remark"]) + "</p>\r\n            ");
        templateBuilder.Append("<p><strong>条形码： <em id=\"Em21\">" + Utils.ObjectToStr(dr["Barcode"]) + "</em> </strong>\r\n</p>		<p>\r\n						<strong>价格： <em id=\"Em21\">" + Utils.ObjectToStr(dr["sell_price"]) + "</em> PLN</strong>\r\n					</p>\r\n	");
        templateBuilder.Append("<p>\r\n						<strong>库存： <em id=\"Em21" + Utils.ObjectToStr(dr["id"]) + "\">" + Utils.ObjectToStr(dr["stock_quantity"]) + "</em> </strong>\r\n					</p>\r\n");
        templateBuilder.Append("</div>\r\n          ");
        templateBuilder.Append("<div style=\"float:left; width:30%\"> <div class=\"pro-btns\">\r\n	<div class=\"input-box\">\r\n              购买数量：");
        ...
        if (Utils.StrToInt(Utils.ObjectToStr(dr["stock_quantity"]), 0) > 0)
        {
            if (count == 0)
        {
            templateBuilder.Append("\r\n            <a href=\"javascript:void(0);\" class=\"add\" onclick=\"CartAddNew(this, '");
            templateBuilder.Append(Utils.ObjectToStr(dr["id"]));
            templateBuilder.Append("','");
            templateBuilder.Append(Utils.ObjectToStr(config.webpath));
