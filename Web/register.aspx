...
override protected void OnInit(EventArgs e)
{
   ...
   */
    ...
    templateBuilder.Append("\r\n<!--/Header-->\r\n<div  style=\"height:10px;\"></div>\r\n\r\n<div class=\"boxwrap\">\r\n  <div class=\"main_box\">\r\n    <h1 class=\"main_tit\">\r\n      " + Resources.lang.account + "<strong>Register</strong>\r\n    </h1>\r\n\r\n    <div class=\"reg-box\">\r\n      <div class=\"reg-top\">\r\n        <ul class=\"step");
	...
	templateBuilder.Append("\r\n          <dl>\r\n            <dt><em>*</em>" + Resources.lang.username+ "：</dt>\r\n            <dd>\r\n              <input id=\"txtUserName\" name=\"txtUserName\" class=\"input wide\" type=\"text\" datatype=\"s3-50\" nullmsg=\"请输入" + Resources.lang.username+ "\" sucmsg=\" \" ajaxurl=\"");
	templateBuilder.Append(Utils.ObjectToStr(config.webpath));
	templateBuilder.Append("tools/submit_ajax.ashx?action=validate_username\" />\r\n              <span class=\"Validform_checktip\"></span>\r\n              <i>（5-20位字母、数字或下划线组合，首字符必须为字母。）</i>\r\n            </dd>\r\n          </dl>\r\n     ");
    templateBuilder.Append("         <dl>\r\n            <dt><em>*</em>配送地址：</dt>\r\n            <dd>\r\n              <input id=\"txtAddr\" name=\"txtAddr\" datatype=\"*\" class=\"input wide\" type=\"text\"   sucmsg=\" \" />\r\n              <span class=\"Validform_checktip\"></span>\r\n              \r\n            </dd>\r\n          </dl>\r\n\r\n\r\n\r\n");
  ...
  */
    templateBuilder.Append(" <dl>\r\n           <dt>Email：</dt>\r\n            <dd>\r\n              <input id=\"txtEmail\" name=\"txtEmail\" class=\"input wide\" type=\"text\" datatype=\"e\" ignore=\"ignore\" sucmsg=\" \" />\r\n              <span class=\"Validform_checktip\"></span>\r\n              <i>（邮箱、QQ号码、微信号至少填写一个！）</i>\r\n            </dd>\r\n          </dl>\r\n\r\n\r\n\r\n");
    templateBuilder.Append("         <dl>\r\n            <dt>QQ：</dt>\r\n            <dd>\r\n              <input id=\"txtQQ\" name=\"txtQQ\" class=\"input wide\" type=\"text\" datatype=\"n5-10\" ignore=\"ignore\"  sucmsg=\" \" />\r\n              <span class=\"Validform_checktip\"></span>\r\n              \r\n            </dd>\r\n          </dl>\r\n\r\n\r\n\r\n");
    templateBuilder.Append("         <dl>\r\n            <dt>微信号：</dt>\r\n            <dd>\r\n              <input id=\"txtWeChat\" name=\"txtWeChat\" class=\"input wide\" type=\"text\"   sucmsg=\" \" />\r\n              <span class=\"Validform_checktip\"></span>\r\n              \r\n            </dd>\r\n          </dl>\r\n\r\n\r\n\r\n");
    templateBuilder.Append("         <dl>\r\n            <dt>商店号：</dt>\r\n            <dd>\r\n              <input id=\"txtCompanyid\" name=\"txtCompanyid\" class=\"input wide\" type=\"text\"   sucmsg=\" \" />\r\n              <span class=\"Validform_checktip\"></span>\r\n              \r\n            </dd>\r\n          </dl>\r\n\r\n\r\n\r\n");
    templateBuilder.Append("         <dl>\r\n            <dt>税号：</dt>\r\n            <dd>\r\n              <input id=\"txtTaxid\" name=\"txtTaxid\" class=\"input wide\" type=\"text\"   sucmsg=\" \" />\r\n              <span class=\"Validform_checktip\"></span>\r\n              \r\n            </dd>\r\n          </dl>\r\n\r\n\r\n\r\n");

    templateBuilder.Append("          <dl>\r\n            <dt><em>*</em>" + Resources.lang.code + "：</dt>\r\n            <dd>\r\n              ");
	...
	if (uconfig.regrules==1)
	{
        ...
        templateBuilder.Append("\r\n          <dl>\r\n            <dt><em>*</em>注册条款：</dt>\r\n            <dd>\r\n              <input id=\"chkAgree\" type=\"checkbox\" value=\"1\" name=\"chkAgree\">\r\n              <label for=\"chkAgree\">" + Resources.lang.sm + "<a href=\"javascript:;\" onclick=\"showWindow('regrules');\">" + Resources.lang.search + "</a>。</label>\r\n              <div id=\"regrules\" title=\"注册许可协议\" style=\"display:none;\">");
	...
	if (uconfig.regrules==1)
	{
        ...
        templateBuilder.Append("\r\n              <input id=\"btnSubmit\" name=\"btnSubmit\" type=\"submit\" class=\"btn_submit\" value=\"" + Resources.lang.account + "\" disabled=\"disabled\" />\r\n              ");
	}
	else
	{

        templateBuilder.Append("\r\n              <input id=\"btnSubmit\" name=\"btnSubmit\" type=\"submit\" class=\"btn_submit\" value=\"" + Resources.lang.account + "\" />\r\n              ");
	}	//end for if
	...
	templateBuilder.Append("\">"+Resources.lang.home+"</a>，点击这里<a href=\"");
	templateBuilder.Append(linkurl("usercenter","index"));
    ...
    templateBuilder.Append("      <p>请牢记您的密码<b><font color=\"red\">");
    templateBuilder.Append(Utils.ObjectToStr(password));
          templateBuilder.Append("</font></b></p>");
    templateBuilder.Append("      <p>点击这里返回<a href=\"");
	templateBuilder.Append(linkurl("index"));

    templateBuilder.Append("\">"+Resources.lang.home+"</a>或点击这里进入会员中心<a href=\"");
    templateBuilder.Append(linkurl("usercenter", "password"));

	templateBuilder.Append("\">" + Resources.lang.changePSD+ "</a>吧！</p>\r\n        </div>\r\n      </div>\r\n      <!--注册成功-->\r\n      ");
	}	//end for if
