      ...
      <table border="0" cellspacing="0" cellpadding="0" class="border-table" width="98%">
        ...
        <tbody id="item_box">
          ...
          <tr class="td_c">
            ...
            <td>
              <a title="编辑" class="img-btn edit operator" onclick="showChannelDialog(this);"><asp:Literal runat="server" Text="<%$ Resources:lang,edit%>" /></a>
              <a title="删除" class="img-btn del operator" onclick="delItemTr(this);"><asp:Literal runat="server" Text="<%$ Resources:lang,delete%>" /></a>
            </td>
          </tr>
          </ItemTemplate>
          </asp:Repeater>
