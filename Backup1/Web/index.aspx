...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("script>\r\n\r\n<div id=\"store_header\">\r\n	<div class=\"header\">\r\n		<div class=\"header_tt\">\r\n        <a class=\"Collect\" href=\"javascript:if(document.all){window.external.addFavorite('http://www.heng24.com','恒24小时便利店');}else if(window.sidebar){window.sidebar.addPanel('恒24小时便利店', 'http://www.heng24.com','');}\" title=\"加入收藏\">收藏本站</a>	\r\n            		    <script type=\"text/javascript\">\r\n            		        $.ajax({\r\n            		            type: \"POST\",\r\n            		            url: \"");
    ...
    if (count == 0)
    {
        ...
        templateBuilder.Append("\">购物车结算</a></div>\r\n							");
    }
    else
    {
        templateBuilder.Append("<div class=\"header_cart_box\">\r\n							<div class=\"header_cart\"> <a href=\"");
 ...
 //   DataTable goodsf1 = get_article_listpp("goods", category_id, vote_id, page, "status=0", out totalcount, out pagelist, "goods_list", category_id, "__id__");
    ...
    if (System.Text.Encoding.Default.GetByteCount(Utils.ObjectToStr(dr["title"])) <= 23)
        templateBuilder.Append("<br/>");
    templateBuilder.Append("</div>\r\n			<p class=\"showcase_goods_style0_rmb\"><strong>条形码： <em id=\"Em21\">" + Utils.ObjectToStr(dr["Barcode"]) + "</em> </strong>\r\n</p>		<p class=\"showcase_goods_style0_rmb\">\r\n						<strong>价格： <em id=\"price" + Utils.ObjectToStr(dr["id"]) + "\">" + Utils.ObjectToStr(dr["sell_price"]) + "</em> PLN</strong>\r\n					</p>\r\n	");
    templateBuilder.Append("<p class=\"showcase_goods_style0_rmb\">\r\n						<strong>库存： <em id=\"Em21" + Utils.ObjectToStr(dr["id"]) + "\">" + Utils.ObjectToStr(dr["stock_quantity"]) + "</em> </strong>\r\n					</p>\r\n");
    ...
    if (Utils.StrToInt(Utils.ObjectToStr(dr["stock_quantity"]), 0) > 0)
    {
        if (count == 0)
        {
            templateBuilder.Append("\r\n            <a id=\"zzz" + Utils.ObjectToStr(dr["id"]) + "\" href=\"javascript:void(0);\" class=\"add\" onclick=\"CartAddNew(this, '");
            templateBuilder.Append(Utils.ObjectToStr(dr["id"]));
            templateBuilder.Append("','");
            templateBuilder.Append(Utils.ObjectToStr(config.webpath));
        ...
        {
            templateBuilder.Append("\r\n            <a  id=\"zzz" + Utils.ObjectToStr(dr["id"]) + "\" href=\"javascript:void(0);\" class=\"add\" onclick=\"CartAddShop(this, '");
            templateBuilder.Append(Utils.ObjectToStr(dr["id"]));
            templateBuilder.Append("','");
            templateBuilder.Append(Utils.ObjectToStr(config.webpath));
             templateBuilder.Append("','");
