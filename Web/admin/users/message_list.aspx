<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="message_list.aspx.cs" Inherits="Web.admin.users.message_list" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="message_edit.aspx?action=<%=AXEnums.ActionEnum.Add %>"><i></i><span>发送消息</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center"><a href="message_edit.aspx?action=<%#AXEnums.ActionEnum.View %>&id=<%#Eval("id")%>">查看</a>
  </tr>
</ItemTemplate>
<FooterTemplate>
