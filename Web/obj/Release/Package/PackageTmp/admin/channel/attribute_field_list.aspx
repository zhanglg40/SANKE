<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="attribute_field_list.aspx.cs" Inherits="Web.admin.channel.attribute_field_list" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="attribute_field_edit.aspx?action=<%=AXEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center"><a href="attribute_field_edit.aspx?action=<%#AXEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
