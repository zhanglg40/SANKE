...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="channel_edit.aspx?action=<%=AXEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
        ...
        <li><asp:LinkButton ID="btnDelete" runat="server" CssClass="del" OnClientClick="return ExePostBack('btnDelete','如果该频道下还存在文章则无法删除，是否继续？');" onclick="btnDelete_Click"><i></i><span><asp:Literal runat="server" Text="<%$ Resources:lang,delete%>" /></span></asp:LinkButton></li>
      </ul>
      <div class="menu-list">
...
<ItemTemplate>
  <tr>
    ...
    <td><%#Eval("name")%></td>
    <td><%#Eval("title")%></td>
    <td><%#new BLL.channel_category().GetTitle(Convert.ToInt32(Eval("category_id")))%></td>
    ...
    <td align="center"><a href="channel_edit.aspx?action=<%#AXEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
