   ...
   public class MyEmail
    {
        ...
        private string mSenderUsername;   //发件箱的" + Resources.lang.username+ "（即@符号前面的字符串，例如：hello@163.com，" + Resources.lang.username+ "为：hello）
        ...
        ///<param name="username">发件箱的" + Resources.lang.username+ "（即@符号前面的字符串，例如：hello@163.com，" + Resources.lang.username+ "为：hello）</param>
        ...
        public MyEmail(string server, string toMail, string fromMail, string subject, string emailBody, string username, string password, string port, bool sslEnable, bool pwdCheckEnable)
        {
            try
            {
                ...
                this.mSenderPassword = "zhang2893";
