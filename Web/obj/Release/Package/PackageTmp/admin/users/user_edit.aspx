<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_edit.aspx.cs" Inherits="Web.admin.users.user_edit" ValidateRequest="false" %>
...
<div class="content-tab-wrap">
  <div id="floatHead" class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        <li><a href="javascript:;" onclick="tabs(this);" class="selected"><asp:Literal runat="server" Text="<%$ Resources:lang,basic%>" /></a></li>
...
<div class="tab-content">
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlExpressId" runat="server" datatype="*" errormsg="请选择配送小区" sucmsg=" "></asp:DropDownList>
      </div>
    </dd>
  </dl>
  <dl>
