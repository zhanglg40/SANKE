...
namespace BLL
{
    ...
    public partial class users
    {
        ...
        /// <summary>
        /// 返回一个随机" + Resources.lang.username+ "
        /// </summary>
        ...
        /// </summary>
        /// <param name="user_name">" + Resources.lang.username+ "(明文)</param>
        ...
        public bool Upgrade(int id)
        {
            ...
            if (result > 0)
            {
                ...
                {
                    new BLL.user_amount_log().Add(model.id, model.user_name, AXEnums.AmountTypeEnum.SysGive.ToString(), groupModel.amount, "升级赠送金额", 1);
                }
            }
            return true;
        }
