<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_config.aspx.cs" Inherits="Web.admin.settings.sys_config" ValidateRequest="false" %>
...
<div class="tab-content" style="display:none">
  <dl>
    ...
    <dd>
      ...
      <span class="Validform_checktip">尚未申请？<a href="http://www.talentosoft.com" target="_blank">请点击这里联系我们</a></span>
    </dd>
  </dl>
  <dl>
    <dt>平台登录账户</dt>
  ...
  <dl>
    <dt>短信平台说明</dt>
    <dd>
      请不要轻易改动，改动前请联系我们； 0552-2079767<br />
...
<div class="tab-content" style="display:none">
  ...
  <dl>
    ...
    <dd>
      ...
      <span class="Validform_checktip">*对方收到邮件时显示的姓名</span>
    </dd>
  </dl>
      <dl>
    <dt>新订单通知</dt>
    <dd>
      <div class="rule-single-checkbox">
          <asp:CheckBox ID="neworderstatus" runat="server" />
      </div>
      <span class="Validform_checktip">*开启后新订单邮件通知</span>
    </dd>
  </dl>
     <dl>
    <dt>新订单通知邮箱账号</dt>
    <dd>
      <asp:TextBox ID="neworderemail" runat="server" CssClass="input normal"  />
