...
templateBuilder.Append(" function get_logon_now() {\r\n        return logon_now;\r\n    }\r\n    function get_real_now() {\r\n        var diff = browser_now.getTime() - logon_now.getTime();\r\n        var now = new Date();\r\n        return new Date(now.getTime() - diff);\r\n    }\r\n</");
 ...
 //   templateBuilder.Append("<th width=\"80\" align=\"center\">积分</th>\r\n        ");
   ...
   // int totalcount = 0;
    ...
    templateBuilder.Append("<tr><th>收货人</th><th>城市</th><th>收货地址</th><th>邮编</th><th>联系电话</th><th>手机号</th><th>使用情况</th><th></th></tr> ");
    ...
    templateBuilder.Append("\"   sucmsg=\" \" style=\"width:200px;\" /></td><td><span class=\"Validform_checktip\">邮编</span></td>\r\n  </tr>");
    ...
    templateBuilder.Append("\"  sucmsg=\" \" /></td><td><span class=\"Validform_checktip\">收货人的手机号码</span></td></tr><tr><td>联系电话：</td>\r\n        <td><input name=\"telphone\" id=\"telphone\" type=\"text\" class=\"input txt\" value=\"");
	templateBuilder.Append(Utils.ObjectToStr(userModel.telphone));
    templateBuilder.Append("\" datatype=\"*2-100\" /></td><td><span class=\"Validform_checktip\">收货人的联系电话</span> </td><td>微信号：</td>\r\n        <td><input name=\"wechat\" id=\"wechat\" type=\"text\" class=\"input txt\" value=\"");
  ...
  //  templateBuilder.Append(" <th width=\"80\" align=\"center\">积分</th>\r\n        ");
    ...
    //templateBuilder.Append("总积分：<font color=\"#FF0000\">");
    //templateBuilder.Append(Utils.ObjectToStr(cartModel.total_point));
    //templateBuilder.Append("</font> 分 &nbsp; &nbsp;&nbsp;");
