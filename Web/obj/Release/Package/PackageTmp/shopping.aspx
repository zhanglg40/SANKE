...
override protected void OnInit(EventArgs e)
{
	...
	*/
    ...
    {
        int totalcount = 0;
        DataTable listn = get_user_address(10, 10, "user_name='" + userModel1.user_name + "'", out totalcount);
        //设置地址
        templateBuilder.Append("function setaddress(addressid){\r\n");
        foreach (DataRow dr in listn.Rows)
        {
            templateBuilder.Append("if('" + Utils.ObjectToStr(dr["id"]) + "'==addressid){\r\n");
            templateBuilder.Append("$('#accept_name').val('" + Utils.ObjectToStr(dr["nick_name"]) + "')");
            templateBuilder.Append(";\r\n");
            templateBuilder.Append("$('#telphone').val('" + Utils.ObjectToStr(dr["telphone"]) + "')");
            templateBuilder.Append(";\r\n");
            templateBuilder.Append("$('#mobile').val('" + Utils.ObjectToStr(dr["mobile"]) + "')");
            templateBuilder.Append(";\r\n");
            templateBuilder.Append("$('#city').val('" + Utils.ObjectToStr(dr["city"]) + "')");
            templateBuilder.Append(";\r\n");
            templateBuilder.Append("$('#post_code').val('" + Utils.ObjectToStr(dr["post_code"]) + "')");
            templateBuilder.Append(";\r\n");
            templateBuilder.Append("$('#address').val('" + Utils.ObjectToStr(dr["address"]) + "')");
            templateBuilder.Append(";\r\n");
...
templateBuilder.Append(" function get_logon_now() {\r\n        return logon_now;\r\n    }\r\n    function get_real_now() {\r\n        var diff = browser_now.getTime() - logon_now.getTime();\r\n        var now = new Date();\r\n        return new Date(now.getTime() - diff);\r\n    }\r\n</");
 ...
 //   templateBuilder.Append("<th width=\"80\" align=\"center\">积分</th>\r\n        ");
    templateBuilder.Append("<th width=\"80\" align=\"center\">" + Resources.lang.unitPrice + "</th>\r\n        <th width=\"80\" align=\"center\">" + Resources.lang.buycount + "</th>\r\n        <th width=\"80\" align=\"center\">优惠</th>\r\n        <th width=\"100\" align=\"center\">" + Resources.lang.subtotal + "</th>\r\n        ");
   //  templateBuilder.Append("<th width=\"100\" align=\"center\">积分小计</th>\r\n        ");
     templateBuilder.Append("<th width=\"50\" align=\"center\">" + Resources.lang.operating+ "</th>\r\n      </tr>\r\n      ");
	...
	templateBuilder.Append("','");
	templateBuilder.Append(Utils.ObjectToStr(modelt.id));
	templateBuilder.Append("');\" href=\"javascript:;\">" + Resources.lang.delete+ "</a></td>\r\n      </tr>\r\n      ");
	}	//end for if

	if (ls1.Count<1)
	{

        templateBuilder.Append("\r\n      <tr>\r\n        <td colspan=\"9\">\r\n          <div class=\"msg_tips\">\r\n            <div class=\"ico warning\"></div>\r\n            <div class=\"msg\">\r\n              <strong>" + Resources.lang.nullCart + "</strong>\r\n              <p>您的购物车为空，<a href=\"");
	templateBuilder.Append(linkurl("index"));
    ...
    templateBuilder.Append("</font> PLN &nbsp;&nbsp;");
    //templateBuilder.Append(" 总积分：<font color=\"#FF0000\" size=\"2\">");
   ...
   // int totalcount = 0;
    ...
    templateBuilder.Append("<tr><th>" + Resources.lang.Receiver+ "</th><th>" + Resources.lang.city+ "</th><th>" + Resources.lang.ShippingAddress+ "</th><th>" + Resources.lang.zipCode+ "</th><th>" + Resources.lang.ContactNo+ "</th><th>" + Resources.lang.phoneNo+ "</th><th>" + Resources.lang.situation+ "</th><th></th></tr> ");
    //   templateBuilder.Append("<tr><td>1</td><td>1</td><td>1</td><td>1</td><td>1</td><td>1</td><td>1</td></tr> </table>");
    templateBuilder.Append(" <!--取得分页页码列表-->\r\n      ");
    int dr__loop__id = 0;
    int totalcount = 0;
    DataTable listn = get_user_address(10, 10, "user_name='" + userModel.user_name + "'", out totalcount);
    foreach (DataRow dr in listn.Rows)
    {
        dr__loop__id++;


        templateBuilder.Append("\r\n      <tr>\r\n    <td width=\"20%\" style=\"text-align:center\">" + Utils.ObjectToStr(dr["nick_name"]) + "</td>\r\n       ");
        ...
        templateBuilder.Append("<td width=\"10%\"><a onclick=\"setaddress('" + Utils.ObjectToStr(dr["id"]) + "');\" href=\"javascript:;\">使用此地址</a></td>\r\n    ");
        templateBuilder.Append(" <td></td> </tr>\r\n      ");
      
    }	//end for if
    templateBuilder.Append(" <tr><td></td> </tr>\r\n      ");
    templateBuilder.Append(" </table>");   
    templateBuilder.Append(" <table><tr><td style=\"width:100px\">   公司名称：</td><td style=\"width:100px\"><input name=\"companyname\" id=\"companyname\" type=\"text\" class=\"input txt wide\" value=\"");
    templateBuilder.Append(Utils.ObjectToStr(userModel.companyname));
    templateBuilder.Append("\"  sucmsg=\" \" /></td><td style=\"width:200px\"><span class=\"Validform_checktip\">公司名称</span></td><td style=\"width:100px\">公司地址：</td>\r\n        <td><input name=\"companyaddress\" id=\"companyaddress\" type=\"text\" class=\"input txt\" value=\"");
    templateBuilder.Append(Utils.ObjectToStr(userModel.companyaddress));
    templateBuilder.Append("\"   sucmsg=\" \" style=\"width:200px;\" /></td><td><span class=\"Validform_checktip\">公司地址</span></td>\r\n  </tr>");
    templateBuilder.Append("<tr><td style=\"width:100px\">   联系人姓名：</td><td style=\"width:100px\"><input name=\"accept_name\" id=\"accept_name\" type=\"text\" class=\"input txt wide\" value=\"");
    templateBuilder.Append(Utils.ObjectToStr(userModel.nick_name));
    templateBuilder.Append("\" datatype=\"s2-20\" sucmsg=\" \" /></td><td style=\"width:200px\"><span class=\"Validform_checktip\">*联系人姓名</span></td><td style=\"width:100px\">邮编：</td>\r\n        <td><input name=\"post_code\" id=\"post_code\" type=\"text\" class=\"input txt\" value=\"");
    templateBuilder.Append(Utils.ObjectToStr(userModel.post_code));
    templateBuilder.Append("\"   sucmsg=\" \" style=\"width:200px;\" /></td><td><span class=\"Validform_checktip\">" + Resources.lang.zipCode+ "</span></td>\r\n  </tr>");
    templateBuilder.Append("<tr><td style=\"width:100px\">   托运城市：</td><td style=\"width:100px\"><input name=\"city\" id=\"city\" type=\"text\" class=\"input txt wide\" value=\"");
    templateBuilder.Append(Utils.ObjectToStr(userModel.city));
    templateBuilder.Append("\"   sucmsg=\" \" /></td><td style=\"width:200px\"><span class=\"Validform_checktip\">托运城市</span></td><td style=\"width:100px\">托运地址：</td>\r\n        <td><input name=\"address\" id=\"address\" type=\"text\" class=\"input txt\" value=\"");
	templateBuilder.Append(Utils.ObjectToStr(userModel.address));
    templateBuilder.Append("\"  sucmsg=\" \" style=\"width:200px;\" /></td><td><span class=\"Validform_checktip\">托运的详细地址</span></td>\r\n  </tr>");
    templateBuilder.Append("<tr><td>商店号：</td>\r\n        <td><input name=\"companyid\" id=\"companyid\" type=\"text\" class=\"input txt wide\" value=\"");
    templateBuilder.Append(Utils.ObjectToStr(userModel.companyid));
    templateBuilder.Append("\"  sucmsg=\" \" /></td><td><span class=\"Validform_checktip\">商店号</span> </td><td> 手机号码：</td>\r\n        <td><input name=\"mobile\" id=\"mobile\" type=\"text\" class=\"input txt\" value=\"");
	templateBuilder.Append(Utils.ObjectToStr(userModel.mobile));
    templateBuilder.Append("\"  sucmsg=\" \" /></td><td><span class=\"Validform_checktip\">" + Resources.lang.Receiver+ "的手机号码</span></td></tr><tr><td>联系电话：</td>\r\n        <td><input name=\"telphone\" id=\"telphone\" type=\"text\" class=\"input txt\" value=\"");
	templateBuilder.Append(Utils.ObjectToStr(userModel.telphone));
    templateBuilder.Append("\" datatype=\"*2-100\" /></td><td><span class=\"Validform_checktip\">" + Resources.lang.Receiver+ "的联系电话</span> </td><td>微信号：</td>\r\n        <td><input name=\"wechat\" id=\"wechat\" type=\"text\" class=\"input txt\" value=\"");
    templateBuilder.Append(Utils.ObjectToStr(userModel.wechat));
    templateBuilder.Append("\" /></td><td><span class=\"Validform_checktip\">微信号</span> </td></tr></table>  </div>\r\n    \r\n    <div class=\"line20\"></div>\r\n    <h3 class=\"bar_tit\">2、" + Resources.lang.paymentMethod + "</h3>\r\n    <ul class=\"item_box\">\r\n      ");
    ...
    templateBuilder.Append("\r\n        <em>" + Resources.lang.Fee + "：");
	templateBuilder.Append(Utils.ObjectToStr(poundage_amount));
	templateBuilder.Append("PLN</em></label>\r\n      </li>\r\n      ");
	}	//end for if
	...
	templateBuilder.Append("\r\n        <em>费用：" + Utils.ObjectToStr(dr2["express_fee"]) + "PLN</em></label>\r\n      </li>\r\n      ");
	}	//end for if

    templateBuilder.Append("\r\n    </ul>\r\n    \r\n    <div class=\"line20\"></div>\r\n    <h3 class=\"bar_tit\">3、" + Resources.lang.goodlist + "</h3>\r\n    <table width=\"938\" border=\"0\" align=\"center\" cellpadding=\"8\" cellspacing=\"0\" class=\"cart_table\">\r\n      <tr>\r\n        <th width=\"64\"></th>\r\n        <th align=\"left\">商品名称</th>\r\n       ");
  //  templateBuilder.Append(" <th width=\"80\" align=\"center\">积分</th>\r\n        ");
    templateBuilder.Append("<th width=\"80\" align=\"center\">" + Resources.lang.unitPrice + "</th>\r\n        <th width=\"80\" align=\"center\">" + Resources.lang.buycount + "</th>\r\n        <th width=\"80\" align=\"center\">优惠</th>\r\n        <th width=\"100\" align=\"center\">" + Resources.lang.subtotal + "</th>\r\n       "); 
      //  templateBuilder.Append(" <th width=\"100\" align=\"center\">积分小计</th>\r\n");
    ...
    templateBuilder.Append(Utils.ObjectToStr(modelt.quantity));
    templateBuilder.Append("</td>\r\n       ");
        templateBuilder.Append(" <td align=\"center\"><label name=\"discount_amount\">");
	templateBuilder.Append(((modelt.price-modelt.user_price)*modelt.quantity).ToString());

    templateBuilder.Append("</label> PLN</td>\r\n        "); 
     templateBuilder.Append("<td align=\"center\"><font color=\"#FF0000\" size=\"2\"><label name=\"real_amount\">");
	templateBuilder.Append((modelt.user_price*modelt.quantity).ToString());
    ...
    if (lang.Equals("pl-PL"))
    {
        templateBuilder.Append("\r\n	</table>\r\n    \r\n    <div class=\"line20\"></div>\r\n    <h3 class=\"bar_tit\">4、Informacje rozliczeniowe</h3>\r\n    <div>\r\n      <div class=\"left\">\r\n        <h4>Zamów wiadomość<span>Liczba słów w 100 znaków</span></h4>\r\n        <textarea name=\"message\" class=\"input\" style=\"width:250px;height:35px;\"></textarea>\r\n      </div>\r\n      \r\n      <div class=\"right\" style=\"text-align:right;line-height:40px;\">\r\n        Liczba towarów：<font color=\"#FF0000\">");
        templateBuilder.Append(Utils.ObjectToStr(cartModel.total_quantity));
        templateBuilder.Append("</font> &nbsp; &nbsp;&nbsp;");

        templateBuilder.Append("Ilość towaru：<font color=\"#FF0000\"><label id=\"goods_amount\">");
        templateBuilder.Append(Utils.ObjectToStr(cartModel.real_amount));
        templateBuilder.Append("</label> PLN</font>&nbsp; &nbsp;+ &nbsp; Ładunek：<font color=\"#FF0000\"><label id=\"express_fee\">0.00</label></font>&nbsp; &nbsp;+ &nbsp; Opłata manipulacyjna：<font color=\"#FF0000\"><label id=\"payment_fee\">0.00</label> PLN</font>\r\n        \r\n        <br />\r\n        <b class=\"font18\">Łączna kwota należna：<font color=\"#FF0000\"><label id=\"order_amount\">");

        templateBuilder.Append(Utils.ObjectToStr(cartModel.real_amount));
        templateBuilder.Append("</label> PLN</font></b>\r\n      </div>\r\n    </div>\r\n\r\n    <div class=\"line20\"></div>\r\n    <div class=\"right\">\r\n      <a class=\"btn\" href=\"");
        templateBuilder.Append(linkurl("shopping", "cart"));

        templateBuilder.Append("\">Wróć do zmiany</a>\r\n      ");
    }
    else
    {
        ...
        templateBuilder.Append("商品金额：<font color=\"#FF0000\"><label id=\"goods_amount\">");
        templateBuilder.Append(Utils.ObjectToStr(cartModel.real_amount));
        templateBuilder.Append("</label> PLN</font>&nbsp; &nbsp;+ &nbsp; 运费：<font color=\"#FF0000\"><label id=\"express_fee\">0.00</label></font>&nbsp; &nbsp;+ &nbsp; 支付手续费：<font color=\"#FF0000\"><label id=\"payment_fee\">0.00</label> PLN</font>\r\n        \r\n        <br />\r\n        <b class=\"font18\">应付总金额：<font color=\"#FF0000\"><label id=\"order_amount\">");
