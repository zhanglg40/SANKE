...
namespace BLL
{
    ...
    public partial class article_category
    {
        ...
        {
            return dal.GetSeoTitle(id);
        }
        public int GetID(int classno)
        {
            return dal.GetID(classno);
        }
        public int GetID(string classno)
        {
            return dal.GetIDbyNo(classno);
        }
        /// <summary>
        /// 增加一条数据
        /// </summary>
        ...
        /// <param name="channel_name">频道名称</param>
        /// <returns></returns>
        public DataTable GetChildListpp(int Top, int parent_id, string channel_name, int category_id)
        {
            int channel_id = new channel().GetChannelId(channel_name);
            return dal.GetChildListpp(Top,parent_id, channel_id, category_id);
        }
        /// <summary>
        /// 取得所有类别列表
        /// </summary>
